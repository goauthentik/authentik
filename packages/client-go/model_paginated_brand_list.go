...
type _PaginatedBrandList PaginatedBrandList
...
func (o *PaginatedBrandList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedBrandList := _PaginatedBrandList{}

	err = json.Unmarshal(data, &varPaginatedBrandList)

	if err != nil {
		return err
	}

	*o = PaginatedBrandList(varPaginatedBrandList)
