...
// checks if the GroupLDAPSourceConnection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupLDAPSourceConnection{}
...
type _GroupLDAPSourceConnection GroupLDAPSourceConnection
...
func (o GroupLDAPSourceConnection) ToMap() (map[string]interface{}, error) {
...
func (o *GroupLDAPSourceConnection) UnmarshalJSON(data []byte) (err error) {
	...
	varGroupLDAPSourceConnection := _GroupLDAPSourceConnection{}

	err = json.Unmarshal(data, &varGroupLDAPSourceConnection)

	if err != nil {
		return err
	}

	*o = GroupLDAPSourceConnection(varGroupLDAPSourceConnection)
