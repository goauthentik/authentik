...
type _KerberosSourcePropertyMapping KerberosSourcePropertyMapping
...
func (o *KerberosSourcePropertyMapping) UnmarshalJSON(data []byte) (err error) {
	...
	varKerberosSourcePropertyMapping := _KerberosSourcePropertyMapping{}

	err = json.Unmarshal(data, &varKerberosSourcePropertyMapping)

	if err != nil {
		return err
	}

	*o = KerberosSourcePropertyMapping(varKerberosSourcePropertyMapping)
