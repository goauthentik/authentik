...
type _PaginatedSSFProviderList PaginatedSSFProviderList
...
func (o *PaginatedSSFProviderList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedSSFProviderList := _PaginatedSSFProviderList{}

	err = json.Unmarshal(data, &varPaginatedSSFProviderList)

	if err != nil {
		return err
	}

	*o = PaginatedSSFProviderList(varPaginatedSSFProviderList)
