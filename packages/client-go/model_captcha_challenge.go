...
func (o *CaptchaChallenge) GetMessages() []FlowMessage {
...
// and a boolean to check if the value has been set.
func (o *CaptchaChallenge) GetMessagesOk() ([]FlowMessage, bool) {
	if o == nil || IsNil(o.Messages) {
		return nil, false
	}
...
func (o *CaptchaChallenge) HasMessages() bool {
	if o != nil && !IsNil(o.Messages) {
		return true
	}
...
func (o *CaptchaChallenge) SetMessages(v []FlowMessage) {
	o.Messages = v
}
