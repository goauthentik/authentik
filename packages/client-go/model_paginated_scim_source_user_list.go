...
type _PaginatedSCIMSourceUserList PaginatedSCIMSourceUserList
...
func (o *PaginatedSCIMSourceUserList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedSCIMSourceUserList := _PaginatedSCIMSourceUserList{}

	err = json.Unmarshal(data, &varPaginatedSCIMSourceUserList)

	if err != nil {
		return err
	}

	*o = PaginatedSCIMSourceUserList(varPaginatedSCIMSourceUserList)
