...
func (o *SessionEndChallenge) GetMessages() []FlowMessage {
...
// and a boolean to check if the value has been set.
func (o *SessionEndChallenge) GetMessagesOk() ([]FlowMessage, bool) {
	if o == nil || IsNil(o.Messages) {
		return nil, false
	}
...
func (o *SessionEndChallenge) HasMessages() bool {
	if o != nil && !IsNil(o.Messages) {
		return true
	}
...
func (o *SessionEndChallenge) SetMessages(v []FlowMessage) {
	o.Messages = v
}
