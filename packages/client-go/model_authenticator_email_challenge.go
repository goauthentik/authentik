...
func (o *AuthenticatorEmailChallenge) GetMessages() []FlowMessage {
...
// and a boolean to check if the value has been set.
func (o *AuthenticatorEmailChallenge) GetMessagesOk() ([]FlowMessage, bool) {
	if o == nil || IsNil(o.Messages) {
		return nil, false
	}
...
func (o *AuthenticatorEmailChallenge) HasMessages() bool {
	if o != nil && !IsNil(o.Messages) {
		return true
	}
...
func (o *AuthenticatorEmailChallenge) SetMessages(v []FlowMessage) {
	o.Messages = v
}
