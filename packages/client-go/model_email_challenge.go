...
func (o *EmailChallenge) GetMessages() []FlowMessage {
...
// and a boolean to check if the value has been set.
func (o *EmailChallenge) GetMessagesOk() ([]FlowMessage, bool) {
	if o == nil || IsNil(o.Messages) {
		return nil, false
	}
...
func (o *EmailChallenge) HasMessages() bool {
	if o != nil && !IsNil(o.Messages) {
		return true
	}
...
func (o *EmailChallenge) SetMessages(v []FlowMessage) {
	o.Messages = v
}
