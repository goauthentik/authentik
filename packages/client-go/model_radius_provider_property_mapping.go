...
type _RadiusProviderPropertyMapping RadiusProviderPropertyMapping
...
func (o *RadiusProviderPropertyMapping) UnmarshalJSON(data []byte) (err error) {
	...
	varRadiusProviderPropertyMapping := _RadiusProviderPropertyMapping{}

	err = json.Unmarshal(data, &varRadiusProviderPropertyMapping)

	if err != nil {
		return err
	}

	*o = RadiusProviderPropertyMapping(varRadiusProviderPropertyMapping)
