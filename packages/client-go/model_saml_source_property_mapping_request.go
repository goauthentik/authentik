...
type _SAMLSourcePropertyMappingRequest SAMLSourcePropertyMappingRequest
...
func (o *SAMLSourcePropertyMappingRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varSAMLSourcePropertyMappingRequest := _SAMLSourcePropertyMappingRequest{}

	err = json.Unmarshal(data, &varSAMLSourcePropertyMappingRequest)

	if err != nil {
		return err
	}

	*o = SAMLSourcePropertyMappingRequest(varSAMLSourcePropertyMappingRequest)
