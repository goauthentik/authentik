...
type _PaginatedScopeMappingList PaginatedScopeMappingList
...
func (o *PaginatedScopeMappingList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedScopeMappingList := _PaginatedScopeMappingList{}
	...
	*o = PaginatedScopeMappingList(varPaginatedScopeMappingList)
