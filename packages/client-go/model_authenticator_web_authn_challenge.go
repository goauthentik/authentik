...
func (o *AuthenticatorWebAuthnChallenge) GetMessages() []FlowMessage {
...
// and a boolean to check if the value has been set.
func (o *AuthenticatorWebAuthnChallenge) GetMessagesOk() ([]FlowMessage, bool) {
	if o == nil || IsNil(o.Messages) {
		return nil, false
	}
...
func (o *AuthenticatorWebAuthnChallenge) HasMessages() bool {
	if o != nil && !IsNil(o.Messages) {
		return true
	}
...
func (o *AuthenticatorWebAuthnChallenge) SetMessages(v []FlowMessage) {
	o.Messages = v
}
