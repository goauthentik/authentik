...
// checks if the PaginatedScheduleList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedScheduleList{}
...
type _PaginatedScheduleList PaginatedScheduleList
...
func (o PaginatedScheduleList) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedScheduleList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedScheduleList := _PaginatedScheduleList{}

	err = json.Unmarshal(data, &varPaginatedScheduleList)

	if err != nil {
		return err
	}

	*o = PaginatedScheduleList(varPaginatedScheduleList)
