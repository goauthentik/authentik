...
// prettier-ignore
{
    ...
    pfvar("success-color.200",       "@color.success.deep");
    pfvar("info-color.100",          "@color.info");
    pfvar("info-color.200",          "@color.info.deep");
    pfvar("warning-color.100",       "@color.warning");
    pfvar("warning-color.200",       "@color.warning.deep");
    pfvar("danger-color.100",        "@color.danger");
    pfvar("danger-color.200",        "@color.danger.deep");
    pfvar("danger-color.300",        "#470000");
}
