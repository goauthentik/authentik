...
/// FlowErrorChallenge : Challenge class when an unhandled error occurs during a stage. Normal users
...
impl FlowErrorChallenge {
    /// Challenge class when an unhandled error occurs during a stage. Normal users are shown an
    /// error message, superusers are shown a full stacktrace.
