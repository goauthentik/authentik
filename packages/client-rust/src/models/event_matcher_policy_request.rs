...
pub struct EventMatcherPolicyRequest {
    ...
    /// Match events created by selected application. When left empty, all applications are
    /// matched.
    #[serde(
        rename = "app",
        default,
    ...
    /// Match events created by selected model. When left empty, all models are matched. When an
    /// app is selected, all the application's models are matched.
    #[serde(
        rename = "model",
        default,
        with = "::serde_with::rust::double_option",
