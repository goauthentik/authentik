...
impl User {
    /// User Serializer
    pub fn new(pk: i32, username: String, name: String, date_joined: String, is_superuser: bool, groups_obj: Option<Vec<models::PartialGroup>>, roles_obj: Option<Vec<models::Role>>, avatar: String, uid: String, uuid: uuid::Uuid, password_change_date: String, last_updated: String) -> User {
        User {
            pk,
            username,
            name,
