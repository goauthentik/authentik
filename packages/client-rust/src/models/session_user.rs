...
/// property) and, if this user is being impersonated, the original user in the `original` property.
...
pub struct SessionUser {
    ...
    pub accounts: Vec<models::UserSelectionUser>,
}

impl SessionUser {
    /// Response for the /user/me endpoint, returns the currently active user (as `user` property)
    /// and, if this user is being impersonated, the original user in the `original` property.
    pub fn new(user: models::UserSelf, accounts: Vec<models::UserSelectionUser>) -> SessionUser {
        SessionUser {
            user,
            original: None,
            accounts,
