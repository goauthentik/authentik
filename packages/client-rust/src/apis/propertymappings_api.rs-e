...
pub async fn propertymappings_all_destroy(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<(), Error<PropertymappingsAllDestroyError>> {
    ...
    let uri_str = format!("{}/propertymappings/all/{pm_uuid}/", configuration.base_path, pm_uuid=crate::apis::urlencode(p_path_pm_uuid));
...
/// PropertyMapping Viewset
pub async fn propertymappings_all_list(configuration: &configuration::Configuration, managed: Option<Vec<String>>, managed__isnull: Option<bool>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>) -> Result<models::PaginatedPropertyMappingList, Error<PropertymappingsAllListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if let Some(ref param_value) = p_query_managed {
        req_builder = match "multi" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("managed".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("managed", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
...
pub async fn propertymappings_all_retrieve(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<models::PropertyMapping, Error<PropertymappingsAllRetrieveError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::PropertyMapping`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::PropertyMapping`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn propertymappings_all_test_create(configuration: &configuration::Configuration, pm_uuid: &str, format_result: Option<bool>, property_mapping_test_request: Option<models::PropertyMappingTestRequest>) -> Result<models::PropertyMappingTestResult, Error<PropertymappingsAllTestCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
    let p_query_format_result = format_result;
    let p_body_property_mapping_test_request = property_mapping_test_request;

    let uri_str = format!("{}/propertymappings/all/{pm_uuid}/test/", configuration.base_path, pm_uuid=crate::apis::urlencode(p_path_pm_uuid));
...
pub async fn propertymappings_all_used_by_list(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<Vec<models::UsedBy>, Error<PropertymappingsAllUsedByListError>> {
    ...
    let uri_str = format!("{}/propertymappings/all/{pm_uuid}/used_by/", configuration.base_path, pm_uuid=crate::apis::urlencode(p_path_pm_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn propertymappings_notification_destroy(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<(), Error<PropertymappingsNotificationDestroyError>> {
    ...
    let uri_str = format!("{}/propertymappings/notification/{pm_uuid}/", configuration.base_path, pm_uuid=crate::apis::urlencode(p_path_pm_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn propertymappings_notification_partial_update(configuration: &configuration::Configuration, pm_uuid: &str, patched_notification_webhook_mapping_request: Option<models::PatchedNotificationWebhookMappingRequest>) -> Result<models::NotificationWebhookMapping, Error<PropertymappingsNotificationPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
    let p_body_patched_notification_webhook_mapping_request = patched_notification_webhook_mapping_request;
...
pub async fn propertymappings_notification_used_by_list(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<Vec<models::UsedBy>, Error<PropertymappingsNotificationUsedByListError>> {
    ...
    let uri_str = format!("{}/propertymappings/notification/{pm_uuid}/used_by/", configuration.base_path, pm_uuid=crate::apis::urlencode(p_path_pm_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn propertymappings_provider_google_workspace_create(configuration: &configuration::Configuration, google_workspace_provider_mapping_request: models::GoogleWorkspaceProviderMappingRequest) -> Result<models::GoogleWorkspaceProviderMapping, Error<PropertymappingsProviderGoogleWorkspaceCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_google_workspace_provider_mapping_request = google_workspace_provider_mapping_request;

    let uri_str = format!("{}/propertymappings/provider/google_workspace/", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
/// GoogleWorkspaceProviderMapping Viewset
pub async fn propertymappings_provider_google_workspace_destroy(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<(), Error<PropertymappingsProviderGoogleWorkspaceDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;

    let uri_str = format!("{}/propertymappings/provider/google_workspace/{pm_uuid}/", configuration.base_path, pm_uuid=crate::apis::urlencode(p_path_pm_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// GoogleWorkspaceProviderMapping Viewset
pub async fn propertymappings_provider_google_workspace_list(configuration: &configuration::Configuration, expression: Option<&str>, managed: Option<Vec<String>>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, pm_uuid: Option<&str>, search: Option<&str>) -> Result<models::PaginatedGoogleWorkspaceProviderMappingList, Error<PropertymappingsProviderGoogleWorkspaceListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// GoogleWorkspaceProviderMapping Viewset
pub async fn propertymappings_provider_google_workspace_partial_update(configuration: &configuration::Configuration, pm_uuid: &str, patched_google_workspace_provider_mapping_request: Option<models::PatchedGoogleWorkspaceProviderMappingRequest>) -> Result<models::GoogleWorkspaceProviderMapping, Error<PropertymappingsProviderGoogleWorkspacePartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
    let p_body_patched_google_workspace_provider_mapping_request = patched_google_workspace_provider_mapping_request;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PropertymappingsProviderGoogleWorkspacePartialUpdateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// GoogleWorkspaceProviderMapping Viewset
pub async fn propertymappings_provider_google_workspace_retrieve(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<models::GoogleWorkspaceProviderMapping, Error<PropertymappingsProviderGoogleWorkspaceRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
...
/// GoogleWorkspaceProviderMapping Viewset
pub async fn propertymappings_provider_google_workspace_update(configuration: &configuration::Configuration, pm_uuid: &str, google_workspace_provider_mapping_request: models::GoogleWorkspaceProviderMappingRequest) -> Result<models::GoogleWorkspaceProviderMapping, Error<PropertymappingsProviderGoogleWorkspaceUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
    let p_body_google_workspace_provider_mapping_request = google_workspace_provider_mapping_request;
...
/// Get a list of all objects that use this object
pub async fn propertymappings_provider_google_workspace_used_by_list(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<Vec<models::UsedBy>, Error<PropertymappingsProviderGoogleWorkspaceUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;

    let uri_str = format!("{}/propertymappings/provider/google_workspace/{pm_uuid}/used_by/", configuration.base_path, pm_uuid=crate::apis::urlencode(p_path_pm_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PropertymappingsProviderGoogleWorkspaceUsedByListError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// MicrosoftEntraProviderMapping Viewset
pub async fn propertymappings_provider_microsoft_entra_create(configuration: &configuration::Configuration, microsoft_entra_provider_mapping_request: models::MicrosoftEntraProviderMappingRequest) -> Result<models::MicrosoftEntraProviderMapping, Error<PropertymappingsProviderMicrosoftEntraCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// MicrosoftEntraProviderMapping Viewset
pub async fn propertymappings_provider_microsoft_entra_destroy(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<(), Error<PropertymappingsProviderMicrosoftEntraDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;

    let uri_str = format!("{}/propertymappings/provider/microsoft_entra/{pm_uuid}/", configuration.base_path, pm_uuid=crate::apis::urlencode(p_path_pm_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// MicrosoftEntraProviderMapping Viewset
pub async fn propertymappings_provider_microsoft_entra_list(configuration: &configuration::Configuration, expression: Option<&str>, managed: Option<Vec<String>>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, pm_uuid: Option<&str>, search: Option<&str>) -> Result<models::PaginatedMicrosoftEntraProviderMappingList, Error<PropertymappingsProviderMicrosoftEntraListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_expression = expression;
    let p_query_managed = managed;
    let p_query_name = name;
...
/// MicrosoftEntraProviderMapping Viewset
pub async fn propertymappings_provider_microsoft_entra_partial_update(configuration: &configuration::Configuration, pm_uuid: &str, patched_microsoft_entra_provider_mapping_request: Option<models::PatchedMicrosoftEntraProviderMappingRequest>) -> Result<models::MicrosoftEntraProviderMapping, Error<PropertymappingsProviderMicrosoftEntraPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
    let p_body_patched_microsoft_entra_provider_mapping_request = patched_microsoft_entra_provider_mapping_request;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PropertymappingsProviderMicrosoftEntraPartialUpdateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// MicrosoftEntraProviderMapping Viewset
pub async fn propertymappings_provider_microsoft_entra_retrieve(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<models::MicrosoftEntraProviderMapping, Error<PropertymappingsProviderMicrosoftEntraRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
...
/// MicrosoftEntraProviderMapping Viewset
pub async fn propertymappings_provider_microsoft_entra_update(configuration: &configuration::Configuration, pm_uuid: &str, microsoft_entra_provider_mapping_request: models::MicrosoftEntraProviderMappingRequest) -> Result<models::MicrosoftEntraProviderMapping, Error<PropertymappingsProviderMicrosoftEntraUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
    let p_body_microsoft_entra_provider_mapping_request = microsoft_entra_provider_mapping_request;
...
/// Get a list of all objects that use this object
pub async fn propertymappings_provider_microsoft_entra_used_by_list(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<Vec<models::UsedBy>, Error<PropertymappingsProviderMicrosoftEntraUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;

    let uri_str = format!("{}/propertymappings/provider/microsoft_entra/{pm_uuid}/used_by/", configuration.base_path, pm_uuid=crate::apis::urlencode(p_path_pm_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn propertymappings_provider_rac_create(configuration: &configuration::Configuration, rac_property_mapping_request: models::RacPropertyMappingRequest) -> Result<models::RacPropertyMapping, Error<PropertymappingsProviderRacCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// RACPropertyMapping Viewset
pub async fn propertymappings_provider_rac_destroy(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<(), Error<PropertymappingsProviderRacDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;

    let uri_str = format!("{}/propertymappings/provider/rac/{pm_uuid}/", configuration.base_path, pm_uuid=crate::apis::urlencode(p_path_pm_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// RACPropertyMapping Viewset
pub async fn propertymappings_provider_rac_list(configuration: &configuration::Configuration, managed: Option<Vec<String>>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>) -> Result<models::PaginatedRacPropertyMappingList, Error<PropertymappingsProviderRacListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_managed = managed;
    let p_query_name = name;
    let p_query_ordering = ordering;
...
/// RACPropertyMapping Viewset
pub async fn propertymappings_provider_rac_partial_update(configuration: &configuration::Configuration, pm_uuid: &str, patched_rac_property_mapping_request: Option<models::PatchedRacPropertyMappingRequest>) -> Result<models::RacPropertyMapping, Error<PropertymappingsProviderRacPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
...
/// RACPropertyMapping Viewset
pub async fn propertymappings_provider_rac_retrieve(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<models::RacPropertyMapping, Error<PropertymappingsProviderRacRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
...
/// RACPropertyMapping Viewset
pub async fn propertymappings_provider_rac_update(configuration: &configuration::Configuration, pm_uuid: &str, rac_property_mapping_request: models::RacPropertyMappingRequest) -> Result<models::RacPropertyMapping, Error<PropertymappingsProviderRacUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
    let p_body_rac_property_mapping_request = rac_property_mapping_request;
...
/// Get a list of all objects that use this object
pub async fn propertymappings_provider_rac_used_by_list(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<Vec<models::UsedBy>, Error<PropertymappingsProviderRacUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;

    let uri_str = format!("{}/propertymappings/provider/rac/{pm_uuid}/used_by/", configuration.base_path, pm_uuid=crate::apis::urlencode(p_path_pm_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn propertymappings_provider_radius_create(configuration: &configuration::Configuration, radius_provider_property_mapping_request: models::RadiusProviderPropertyMappingRequest) -> Result<models::RadiusProviderPropertyMapping, Error<PropertymappingsProviderRadiusCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// RadiusProviderPropertyMapping Viewset
pub async fn propertymappings_provider_radius_destroy(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<(), Error<PropertymappingsProviderRadiusDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;

    let uri_str = format!("{}/propertymappings/provider/radius/{pm_uuid}/", configuration.base_path, pm_uuid=crate::apis::urlencode(p_path_pm_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// RadiusProviderPropertyMapping Viewset
pub async fn propertymappings_provider_radius_list(configuration: &configuration::Configuration, managed: Option<Vec<String>>, managed__isnull: Option<bool>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>) -> Result<models::PaginatedRadiusProviderPropertyMappingList, Error<PropertymappingsProviderRadiusListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_managed = managed;
    let p_query_managed__isnull = managed__isnull;
    let p_query_name = name;
...
/// RadiusProviderPropertyMapping Viewset
pub async fn propertymappings_provider_radius_partial_update(configuration: &configuration::Configuration, pm_uuid: &str, patched_radius_provider_property_mapping_request: Option<models::PatchedRadiusProviderPropertyMappingRequest>) -> Result<models::RadiusProviderPropertyMapping, Error<PropertymappingsProviderRadiusPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
    let p_body_patched_radius_provider_property_mapping_request = patched_radius_provider_property_mapping_request;
...
/// RadiusProviderPropertyMapping Viewset
pub async fn propertymappings_provider_radius_retrieve(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<models::RadiusProviderPropertyMapping, Error<PropertymappingsProviderRadiusRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
...
/// RadiusProviderPropertyMapping Viewset
pub async fn propertymappings_provider_radius_update(configuration: &configuration::Configuration, pm_uuid: &str, radius_provider_property_mapping_request: models::RadiusProviderPropertyMappingRequest) -> Result<models::RadiusProviderPropertyMapping, Error<PropertymappingsProviderRadiusUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
    let p_body_radius_provider_property_mapping_request = radius_provider_property_mapping_request;
...
/// Get a list of all objects that use this object
pub async fn propertymappings_provider_radius_used_by_list(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<Vec<models::UsedBy>, Error<PropertymappingsProviderRadiusUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;

    let uri_str = format!("{}/propertymappings/provider/radius/{pm_uuid}/used_by/", configuration.base_path, pm_uuid=crate::apis::urlencode(p_path_pm_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn propertymappings_provider_saml_create(configuration: &configuration::Configuration, saml_property_mapping_request: models::SamlPropertyMappingRequest) -> Result<models::SamlPropertyMapping, Error<PropertymappingsProviderSamlCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// SAMLPropertyMapping Viewset
pub async fn propertymappings_provider_saml_destroy(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<(), Error<PropertymappingsProviderSamlDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;

    let uri_str = format!("{}/propertymappings/provider/saml/{pm_uuid}/", configuration.base_path, pm_uuid=crate::apis::urlencode(p_path_pm_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// SAMLPropertyMapping Viewset
pub async fn propertymappings_provider_saml_list(configuration: &configuration::Configuration, friendly_name: Option<&str>, managed: Option<Vec<String>>, managed__isnull: Option<bool>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, saml_name: Option<&str>, search: Option<&str>) -> Result<models::PaginatedSamlPropertyMappingList, Error<PropertymappingsProviderSamlListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// SAMLPropertyMapping Viewset
pub async fn propertymappings_provider_saml_partial_update(configuration: &configuration::Configuration, pm_uuid: &str, patched_saml_property_mapping_request: Option<models::PatchedSamlPropertyMappingRequest>) -> Result<models::SamlPropertyMapping, Error<PropertymappingsProviderSamlPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
...
/// SAMLPropertyMapping Viewset
pub async fn propertymappings_provider_saml_retrieve(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<models::SamlPropertyMapping, Error<PropertymappingsProviderSamlRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
...
/// SAMLPropertyMapping Viewset
pub async fn propertymappings_provider_saml_update(configuration: &configuration::Configuration, pm_uuid: &str, saml_property_mapping_request: models::SamlPropertyMappingRequest) -> Result<models::SamlPropertyMapping, Error<PropertymappingsProviderSamlUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
    let p_body_saml_property_mapping_request = saml_property_mapping_request;
...
/// Get a list of all objects that use this object
pub async fn propertymappings_provider_saml_used_by_list(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<Vec<models::UsedBy>, Error<PropertymappingsProviderSamlUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;

    let uri_str = format!("{}/propertymappings/provider/saml/{pm_uuid}/used_by/", configuration.base_path, pm_uuid=crate::apis::urlencode(p_path_pm_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
/// SCIMMapping Viewset
pub async fn propertymappings_provider_scim_create(configuration: &configuration::Configuration, scim_mapping_request: models::ScimMappingRequest) -> Result<models::ScimMapping, Error<PropertymappingsProviderScimCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ScimMapping`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ScimMapping`")))),
        }
    } else {
        let content = resp.text().await?;
...
/// SCIMMapping Viewset
pub async fn propertymappings_provider_scim_destroy(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<(), Error<PropertymappingsProviderScimDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;

    let uri_str = format!("{}/propertymappings/provider/scim/{pm_uuid}/", configuration.base_path, pm_uuid=crate::apis::urlencode(p_path_pm_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// SCIMMapping Viewset
pub async fn propertymappings_provider_scim_list(configuration: &configuration::Configuration, managed: Option<Vec<String>>, managed__isnull: Option<bool>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>) -> Result<models::PaginatedScimMappingList, Error<PropertymappingsProviderScimListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_managed = managed;
    let p_query_managed__isnull = managed__isnull;
    let p_query_name = name;
...
/// SCIMMapping Viewset
pub async fn propertymappings_provider_scim_partial_update(configuration: &configuration::Configuration, pm_uuid: &str, patched_scim_mapping_request: Option<models::PatchedScimMappingRequest>) -> Result<models::ScimMapping, Error<PropertymappingsProviderScimPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
...
/// SCIMMapping Viewset
pub async fn propertymappings_provider_scim_retrieve(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<models::ScimMapping, Error<PropertymappingsProviderScimRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
...
/// SCIMMapping Viewset
pub async fn propertymappings_provider_scim_update(configuration: &configuration::Configuration, pm_uuid: &str, scim_mapping_request: models::ScimMappingRequest) -> Result<models::ScimMapping, Error<PropertymappingsProviderScimUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
    let p_body_scim_mapping_request = scim_mapping_request;
...
/// Get a list of all objects that use this object
pub async fn propertymappings_provider_scim_used_by_list(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<Vec<models::UsedBy>, Error<PropertymappingsProviderScimUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;

    let uri_str = format!("{}/propertymappings/provider/scim/{pm_uuid}/used_by/", configuration.base_path, pm_uuid=crate::apis::urlencode(p_path_pm_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn propertymappings_provider_scope_create(configuration: &configuration::Configuration, scope_mapping_request: models::ScopeMappingRequest) -> Result<models::ScopeMapping, Error<PropertymappingsProviderScopeCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ScopeMapping`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ScopeMapping`")))),
        }
    } else {
        let content = resp.text().await?;
...
/// ScopeMapping Viewset
pub async fn propertymappings_provider_scope_destroy(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<(), Error<PropertymappingsProviderScopeDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;

    let uri_str = format!("{}/propertymappings/provider/scope/{pm_uuid}/", configuration.base_path, pm_uuid=crate::apis::urlencode(p_path_pm_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// ScopeMapping Viewset
pub async fn propertymappings_provider_scope_partial_update(configuration: &configuration::Configuration, pm_uuid: &str, patched_scope_mapping_request: Option<models::PatchedScopeMappingRequest>) -> Result<models::ScopeMapping, Error<PropertymappingsProviderScopePartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
...
/// ScopeMapping Viewset
pub async fn propertymappings_provider_scope_retrieve(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<models::ScopeMapping, Error<PropertymappingsProviderScopeRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
...
/// ScopeMapping Viewset
pub async fn propertymappings_provider_scope_update(configuration: &configuration::Configuration, pm_uuid: &str, scope_mapping_request: models::ScopeMappingRequest) -> Result<models::ScopeMapping, Error<PropertymappingsProviderScopeUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
    let p_body_scope_mapping_request = scope_mapping_request;
...
/// Get a list of all objects that use this object
pub async fn propertymappings_provider_scope_used_by_list(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<Vec<models::UsedBy>, Error<PropertymappingsProviderScopeUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;

    let uri_str = format!("{}/propertymappings/provider/scope/{pm_uuid}/used_by/", configuration.base_path, pm_uuid=crate::apis::urlencode(p_path_pm_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn propertymappings_source_kerberos_create(configuration: &configuration::Configuration, kerberos_source_property_mapping_request: models::KerberosSourcePropertyMappingRequest) -> Result<models::KerberosSourcePropertyMapping, Error<PropertymappingsSourceKerberosCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// KerberosSource PropertyMapping Viewset
pub async fn propertymappings_source_kerberos_destroy(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<(), Error<PropertymappingsSourceKerberosDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;

    let uri_str = format!("{}/propertymappings/source/kerberos/{pm_uuid}/", configuration.base_path, pm_uuid=crate::apis::urlencode(p_path_pm_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// KerberosSource PropertyMapping Viewset
pub async fn propertymappings_source_kerberos_list(configuration: &configuration::Configuration, managed: Option<Vec<String>>, managed__isnull: Option<bool>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>) -> Result<models::PaginatedKerberosSourcePropertyMappingList, Error<PropertymappingsSourceKerberosListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_managed = managed;
    let p_query_managed__isnull = managed__isnull;
    let p_query_name = name;
...
/// KerberosSource PropertyMapping Viewset
pub async fn propertymappings_source_kerberos_retrieve(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<models::KerberosSourcePropertyMapping, Error<PropertymappingsSourceKerberosRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
...
/// KerberosSource PropertyMapping Viewset
pub async fn propertymappings_source_kerberos_update(configuration: &configuration::Configuration, pm_uuid: &str, kerberos_source_property_mapping_request: models::KerberosSourcePropertyMappingRequest) -> Result<models::KerberosSourcePropertyMapping, Error<PropertymappingsSourceKerberosUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
    let p_body_kerberos_source_property_mapping_request = kerberos_source_property_mapping_request;
...
/// Get a list of all objects that use this object
pub async fn propertymappings_source_kerberos_used_by_list(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<Vec<models::UsedBy>, Error<PropertymappingsSourceKerberosUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;

    let uri_str = format!("{}/propertymappings/source/kerberos/{pm_uuid}/used_by/", configuration.base_path, pm_uuid=crate::apis::urlencode(p_path_pm_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn propertymappings_source_ldap_create(configuration: &configuration::Configuration, ldap_source_property_mapping_request: models::LdapSourcePropertyMappingRequest) -> Result<models::LdapSourcePropertyMapping, Error<PropertymappingsSourceLdapCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// LDAP PropertyMapping Viewset
pub async fn propertymappings_source_ldap_destroy(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<(), Error<PropertymappingsSourceLdapDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;

    let uri_str = format!("{}/propertymappings/source/ldap/{pm_uuid}/", configuration.base_path, pm_uuid=crate::apis::urlencode(p_path_pm_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// LDAP PropertyMapping Viewset
pub async fn propertymappings_source_ldap_list(configuration: &configuration::Configuration, managed: Option<Vec<String>>, managed__isnull: Option<bool>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>) -> Result<models::PaginatedLdapSourcePropertyMappingList, Error<PropertymappingsSourceLdapListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_managed = managed;
    let p_query_managed__isnull = managed__isnull;
    let p_query_name = name;
...
/// LDAP PropertyMapping Viewset
pub async fn propertymappings_source_ldap_partial_update(configuration: &configuration::Configuration, pm_uuid: &str, patched_ldap_source_property_mapping_request: Option<models::PatchedLdapSourcePropertyMappingRequest>) -> Result<models::LdapSourcePropertyMapping, Error<PropertymappingsSourceLdapPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
    let p_body_patched_ldap_source_property_mapping_request = patched_ldap_source_property_mapping_request;
...
/// LDAP PropertyMapping Viewset
pub async fn propertymappings_source_ldap_retrieve(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<models::LdapSourcePropertyMapping, Error<PropertymappingsSourceLdapRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
...
/// LDAP PropertyMapping Viewset
pub async fn propertymappings_source_ldap_update(configuration: &configuration::Configuration, pm_uuid: &str, ldap_source_property_mapping_request: models::LdapSourcePropertyMappingRequest) -> Result<models::LdapSourcePropertyMapping, Error<PropertymappingsSourceLdapUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
    let p_body_ldap_source_property_mapping_request = ldap_source_property_mapping_request;
...
/// Get a list of all objects that use this object
pub async fn propertymappings_source_ldap_used_by_list(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<Vec<models::UsedBy>, Error<PropertymappingsSourceLdapUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;

    let uri_str = format!("{}/propertymappings/source/ldap/{pm_uuid}/used_by/", configuration.base_path, pm_uuid=crate::apis::urlencode(p_path_pm_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn propertymappings_source_oauth_create(configuration: &configuration::Configuration, o_auth_source_property_mapping_request: models::OAuthSourcePropertyMappingRequest) -> Result<models::OAuthSourcePropertyMapping, Error<PropertymappingsSourceOauthCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// OAuthSourcePropertyMapping Viewset
pub async fn propertymappings_source_oauth_destroy(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<(), Error<PropertymappingsSourceOauthDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;

    let uri_str = format!("{}/propertymappings/source/oauth/{pm_uuid}/", configuration.base_path, pm_uuid=crate::apis::urlencode(p_path_pm_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// OAuthSourcePropertyMapping Viewset
pub async fn propertymappings_source_oauth_list(configuration: &configuration::Configuration, managed: Option<Vec<String>>, managed__isnull: Option<bool>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>) -> Result<models::PaginatedOAuthSourcePropertyMappingList, Error<PropertymappingsSourceOauthListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_managed = managed;
    let p_query_managed__isnull = managed__isnull;
    let p_query_name = name;
...
/// OAuthSourcePropertyMapping Viewset
pub async fn propertymappings_source_oauth_partial_update(configuration: &configuration::Configuration, pm_uuid: &str, patched_o_auth_source_property_mapping_request: Option<models::PatchedOAuthSourcePropertyMappingRequest>) -> Result<models::OAuthSourcePropertyMapping, Error<PropertymappingsSourceOauthPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
    let p_body_patched_o_auth_source_property_mapping_request = patched_o_auth_source_property_mapping_request;
...
/// OAuthSourcePropertyMapping Viewset
pub async fn propertymappings_source_oauth_retrieve(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<models::OAuthSourcePropertyMapping, Error<PropertymappingsSourceOauthRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
...
/// OAuthSourcePropertyMapping Viewset
pub async fn propertymappings_source_oauth_update(configuration: &configuration::Configuration, pm_uuid: &str, o_auth_source_property_mapping_request: models::OAuthSourcePropertyMappingRequest) -> Result<models::OAuthSourcePropertyMapping, Error<PropertymappingsSourceOauthUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
    let p_body_o_auth_source_property_mapping_request = o_auth_source_property_mapping_request;
...
/// Get a list of all objects that use this object
pub async fn propertymappings_source_oauth_used_by_list(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<Vec<models::UsedBy>, Error<PropertymappingsSourceOauthUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;

    let uri_str = format!("{}/propertymappings/source/oauth/{pm_uuid}/used_by/", configuration.base_path, pm_uuid=crate::apis::urlencode(p_path_pm_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn propertymappings_source_plex_create(configuration: &configuration::Configuration, plex_source_property_mapping_request: models::PlexSourcePropertyMappingRequest) -> Result<models::PlexSourcePropertyMapping, Error<PropertymappingsSourcePlexCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// PlexSourcePropertyMapping Viewset
pub async fn propertymappings_source_plex_destroy(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<(), Error<PropertymappingsSourcePlexDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;

    let uri_str = format!("{}/propertymappings/source/plex/{pm_uuid}/", configuration.base_path, pm_uuid=crate::apis::urlencode(p_path_pm_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// PlexSourcePropertyMapping Viewset
pub async fn propertymappings_source_plex_list(configuration: &configuration::Configuration, managed: Option<Vec<String>>, managed__isnull: Option<bool>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>) -> Result<models::PaginatedPlexSourcePropertyMappingList, Error<PropertymappingsSourcePlexListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_managed = managed;
    let p_query_managed__isnull = managed__isnull;
    let p_query_name = name;
...
/// PlexSourcePropertyMapping Viewset
pub async fn propertymappings_source_plex_partial_update(configuration: &configuration::Configuration, pm_uuid: &str, patched_plex_source_property_mapping_request: Option<models::PatchedPlexSourcePropertyMappingRequest>) -> Result<models::PlexSourcePropertyMapping, Error<PropertymappingsSourcePlexPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
    let p_body_patched_plex_source_property_mapping_request = patched_plex_source_property_mapping_request;
...
/// PlexSourcePropertyMapping Viewset
pub async fn propertymappings_source_plex_retrieve(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<models::PlexSourcePropertyMapping, Error<PropertymappingsSourcePlexRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
...
/// PlexSourcePropertyMapping Viewset
pub async fn propertymappings_source_plex_update(configuration: &configuration::Configuration, pm_uuid: &str, plex_source_property_mapping_request: models::PlexSourcePropertyMappingRequest) -> Result<models::PlexSourcePropertyMapping, Error<PropertymappingsSourcePlexUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
    let p_body_plex_source_property_mapping_request = plex_source_property_mapping_request;
...
/// Get a list of all objects that use this object
pub async fn propertymappings_source_plex_used_by_list(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<Vec<models::UsedBy>, Error<PropertymappingsSourcePlexUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;

    let uri_str = format!("{}/propertymappings/source/plex/{pm_uuid}/used_by/", configuration.base_path, pm_uuid=crate::apis::urlencode(p_path_pm_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn propertymappings_source_saml_create(configuration: &configuration::Configuration, saml_source_property_mapping_request: models::SamlSourcePropertyMappingRequest) -> Result<models::SamlSourcePropertyMapping, Error<PropertymappingsSourceSamlCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// SAMLSourcePropertyMapping Viewset
pub async fn propertymappings_source_saml_destroy(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<(), Error<PropertymappingsSourceSamlDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;

    let uri_str = format!("{}/propertymappings/source/saml/{pm_uuid}/", configuration.base_path, pm_uuid=crate::apis::urlencode(p_path_pm_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// SAMLSourcePropertyMapping Viewset
pub async fn propertymappings_source_saml_list(configuration: &configuration::Configuration, managed: Option<Vec<String>>, managed__isnull: Option<bool>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>) -> Result<models::PaginatedSamlSourcePropertyMappingList, Error<PropertymappingsSourceSamlListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_managed = managed;
    let p_query_managed__isnull = managed__isnull;
    let p_query_name = name;
...
/// SAMLSourcePropertyMapping Viewset
pub async fn propertymappings_source_saml_partial_update(configuration: &configuration::Configuration, pm_uuid: &str, patched_saml_source_property_mapping_request: Option<models::PatchedSamlSourcePropertyMappingRequest>) -> Result<models::SamlSourcePropertyMapping, Error<PropertymappingsSourceSamlPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
    let p_body_patched_saml_source_property_mapping_request = patched_saml_source_property_mapping_request;
...
/// SAMLSourcePropertyMapping Viewset
pub async fn propertymappings_source_saml_retrieve(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<models::SamlSourcePropertyMapping, Error<PropertymappingsSourceSamlRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
...
/// SAMLSourcePropertyMapping Viewset
pub async fn propertymappings_source_saml_update(configuration: &configuration::Configuration, pm_uuid: &str, saml_source_property_mapping_request: models::SamlSourcePropertyMappingRequest) -> Result<models::SamlSourcePropertyMapping, Error<PropertymappingsSourceSamlUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
    let p_body_saml_source_property_mapping_request = saml_source_property_mapping_request;
...
/// Get a list of all objects that use this object
pub async fn propertymappings_source_saml_used_by_list(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<Vec<models::UsedBy>, Error<PropertymappingsSourceSamlUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;

    let uri_str = format!("{}/propertymappings/source/saml/{pm_uuid}/used_by/", configuration.base_path, pm_uuid=crate::apis::urlencode(p_path_pm_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn propertymappings_source_scim_create(configuration: &configuration::Configuration, scim_source_property_mapping_request: models::ScimSourcePropertyMappingRequest) -> Result<models::ScimSourcePropertyMapping, Error<PropertymappingsSourceScimCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// SCIMSourcePropertyMapping Viewset
pub async fn propertymappings_source_scim_destroy(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<(), Error<PropertymappingsSourceScimDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;

    let uri_str = format!("{}/propertymappings/source/scim/{pm_uuid}/", configuration.base_path, pm_uuid=crate::apis::urlencode(p_path_pm_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// SCIMSourcePropertyMapping Viewset
pub async fn propertymappings_source_scim_list(configuration: &configuration::Configuration, managed: Option<Vec<String>>, managed__isnull: Option<bool>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>) -> Result<models::PaginatedScimSourcePropertyMappingList, Error<PropertymappingsSourceScimListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_managed = managed;
    let p_query_managed__isnull = managed__isnull;
    let p_query_name = name;
...
/// SCIMSourcePropertyMapping Viewset
pub async fn propertymappings_source_scim_partial_update(configuration: &configuration::Configuration, pm_uuid: &str, patched_scim_source_property_mapping_request: Option<models::PatchedScimSourcePropertyMappingRequest>) -> Result<models::ScimSourcePropertyMapping, Error<PropertymappingsSourceScimPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
    let p_body_patched_scim_source_property_mapping_request = patched_scim_source_property_mapping_request;
...
/// SCIMSourcePropertyMapping Viewset
pub async fn propertymappings_source_scim_retrieve(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<models::ScimSourcePropertyMapping, Error<PropertymappingsSourceScimRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
...
/// SCIMSourcePropertyMapping Viewset
pub async fn propertymappings_source_scim_update(configuration: &configuration::Configuration, pm_uuid: &str, scim_source_property_mapping_request: models::ScimSourcePropertyMappingRequest) -> Result<models::ScimSourcePropertyMapping, Error<PropertymappingsSourceScimUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
    let p_body_scim_source_property_mapping_request = scim_source_property_mapping_request;
...
/// Get a list of all objects that use this object
pub async fn propertymappings_source_scim_used_by_list(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<Vec<models::UsedBy>, Error<PropertymappingsSourceScimUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;

    let uri_str = format!("{}/propertymappings/source/scim/{pm_uuid}/used_by/", configuration.base_path, pm_uuid=crate::apis::urlencode(p_path_pm_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn propertymappings_source_telegram_create(configuration: &configuration::Configuration, telegram_source_property_mapping_request: models::TelegramSourcePropertyMappingRequest) -> Result<models::TelegramSourcePropertyMapping, Error<PropertymappingsSourceTelegramCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// TelegramSourcePropertyMapping Viewset
pub async fn propertymappings_source_telegram_destroy(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<(), Error<PropertymappingsSourceTelegramDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;

    let uri_str = format!("{}/propertymappings/source/telegram/{pm_uuid}/", configuration.base_path, pm_uuid=crate::apis::urlencode(p_path_pm_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// TelegramSourcePropertyMapping Viewset
pub async fn propertymappings_source_telegram_list(configuration: &configuration::Configuration, managed: Option<Vec<String>>, managed__isnull: Option<bool>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>) -> Result<models::PaginatedTelegramSourcePropertyMappingList, Error<PropertymappingsSourceTelegramListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_managed = managed;
    let p_query_managed__isnull = managed__isnull;
    let p_query_name = name;
...
/// TelegramSourcePropertyMapping Viewset
pub async fn propertymappings_source_telegram_partial_update(configuration: &configuration::Configuration, pm_uuid: &str, patched_telegram_source_property_mapping_request: Option<models::PatchedTelegramSourcePropertyMappingRequest>) -> Result<models::TelegramSourcePropertyMapping, Error<PropertymappingsSourceTelegramPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
...
/// TelegramSourcePropertyMapping Viewset
pub async fn propertymappings_source_telegram_retrieve(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<models::TelegramSourcePropertyMapping, Error<PropertymappingsSourceTelegramRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
...
/// TelegramSourcePropertyMapping Viewset
pub async fn propertymappings_source_telegram_update(configuration: &configuration::Configuration, pm_uuid: &str, telegram_source_property_mapping_request: models::TelegramSourcePropertyMappingRequest) -> Result<models::TelegramSourcePropertyMapping, Error<PropertymappingsSourceTelegramUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;
    let p_body_telegram_source_property_mapping_request = telegram_source_property_mapping_request;
...
/// Get a list of all objects that use this object
pub async fn propertymappings_source_telegram_used_by_list(configuration: &configuration::Configuration, pm_uuid: &str) -> Result<Vec<models::UsedBy>, Error<PropertymappingsSourceTelegramUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pm_uuid = pm_uuid;

    let uri_str = format!("{}/propertymappings/source/telegram/{pm_uuid}/used_by/", configuration.base_path, pm_uuid=crate::apis::urlencode(p_path_pm_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
