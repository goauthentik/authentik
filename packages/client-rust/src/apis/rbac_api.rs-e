...
pub async fn rbac_initial_permissions_create(configuration: &configuration::Configuration, initial_permissions_request: models::InitialPermissionsRequest) -> Result<models::InitialPermissions, Error<RbacInitialPermissionsCreateError>> {
...
/// InitialPermissions viewset
pub async fn rbac_initial_permissions_destroy(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<RbacInitialPermissionsDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/rbac/initial_permissions/{id}/", configuration.base_path, id=p_path_id);
...
/// InitialPermissions viewset
pub async fn rbac_initial_permissions_list(configuration: &configuration::Configuration, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>) -> Result<models::PaginatedInitialPermissionsList, Error<RbacInitialPermissionsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// InitialPermissions viewset
pub async fn rbac_initial_permissions_partial_update(configuration: &configuration::Configuration, id: i32, patched_initial_permissions_request: Option<models::PatchedInitialPermissionsRequest>) -> Result<models::InitialPermissions, Error<RbacInitialPermissionsPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// InitialPermissions viewset
pub async fn rbac_initial_permissions_retrieve(configuration: &configuration::Configuration, id: i32) -> Result<models::InitialPermissions, Error<RbacInitialPermissionsRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
/// InitialPermissions viewset
pub async fn rbac_initial_permissions_update(configuration: &configuration::Configuration, id: i32, initial_permissions_request: models::InitialPermissionsRequest) -> Result<models::InitialPermissions, Error<RbacInitialPermissionsUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_body_initial_permissions_request = initial_permissions_request;
...
pub async fn rbac_initial_permissions_used_by_list(configuration: &configuration::Configuration, id: i32) -> Result<Vec<models::UsedBy>, Error<RbacInitialPermissionsUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/rbac/initial_permissions/{id}/used_by/", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn rbac_permissions_assigned_by_roles_assign(configuration: &configuration::Configuration, uuid: &str, permission_assign_request: models::PermissionAssignRequest) -> Result<Vec<models::PermissionAssignResult>, Error<RbacPermissionsAssignedByRolesAssignError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;
    let p_body_permission_assign_request = permission_assign_request;

    let uri_str = format!("{}/rbac/permissions/assigned_by_roles/{uuid}/assign/", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn rbac_permissions_assigned_by_roles_unassign_partial_update(configuration: &configuration::Configuration, uuid: &str, patched_permission_assign_request: Option<models::PatchedPermissionAssignRequest>) -> Result<(), Error<RbacPermissionsAssignedByRolesUnassignPartialUpdateError>> {
    ...
    let uri_str = format!("{}/rbac/permissions/assigned_by_roles/{uuid}/unassign/", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::PATCH, &uri_str);
...
pub async fn rbac_permissions_roles_list(configuration: &configuration::Configuration, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>, uuid: Option<&str>) -> Result<models::PaginatedExtraRoleObjectPermissionList, Error<RbacPermissionsRolesListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ordering = ordering;
    let p_query_page = page;
    let p_query_page_size = page_size;
...
/// Add user to role
pub async fn rbac_roles_add_user_create(configuration: &configuration::Configuration, uuid: &str, user_account_serializer_for_role_request: models::UserAccountSerializerForRoleRequest) -> Result<(), Error<RbacRolesAddUserCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;
    let p_body_user_account_serializer_for_role_request = user_account_serializer_for_role_request;

    let uri_str = format!("{}/rbac/roles/{uuid}/add_user/", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn rbac_roles_destroy(configuration: &configuration::Configuration, uuid: &str) -> Result<(), Error<RbacRolesDestroyError>> {
    ...
    let uri_str = format!("{}/rbac/roles/{uuid}/", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// Role viewset
pub async fn rbac_roles_list(configuration: &configuration::Configuration, groups: Option<&str>, inherited: Option<bool>, managed: Option<Vec<String>>, managed__isnull: Option<bool>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>, users: Option<i32>) -> Result<models::PaginatedRoleList, Error<RbacRolesListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn rbac_roles_remove_user_create(configuration: &configuration::Configuration, uuid: &str, user_account_serializer_for_role_request: models::UserAccountSerializerForRoleRequest) -> Result<(), Error<RbacRolesRemoveUserCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;
    let p_body_user_account_serializer_for_role_request = user_account_serializer_for_role_request;

    let uri_str = format!("{}/rbac/roles/{uuid}/remove_user/", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn rbac_roles_used_by_list(configuration: &configuration::Configuration, uuid: &str) -> Result<Vec<models::UsedBy>, Error<RbacRolesUsedByListError>> {
    ...
    let uri_str = format!("{}/rbac/roles/{uuid}/used_by/", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
