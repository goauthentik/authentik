...
pub async fn schema_retrieve(configuration: &configuration::Configuration, format: Option<models::FormatEnum>, lang: Option<models::LangEnum>) -> Result<std::collections::HashMap<String, serde_json::Value>, Error<SchemaRetrieveError>> {
