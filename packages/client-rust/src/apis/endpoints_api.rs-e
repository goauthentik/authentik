...
pub async fn endpoints_agents_connectors_agent_config_retrieve(configuration: &configuration::Configuration, ) -> Result<models::AgentConfig, Error<EndpointsAgentsConnectorsAgentConfigRetrieveError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::AgentConfig`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::AgentConfig`")))),
        }
    } else {
        let content = resp.text().await?;
...
/// Mixin to add a used_by endpoint to return a list of all objects using this object
pub async fn endpoints_agents_connectors_auth_fed_create(configuration: &configuration::Configuration, device: &str) -> Result<models::AgentTokenResponse, Error<EndpointsAgentsConnectorsAuthFedCreateError>> {
...
/// Mixin to add a used_by endpoint to return a list of all objects using this object
pub async fn endpoints_agents_connectors_auth_ia_create(configuration: &configuration::Configuration, ) -> Result<models::AgentAuthenticationResponse, Error<EndpointsAgentsConnectorsAuthIaCreateError>> {
...
/// Mixin to add a used_by endpoint to return a list of all objects using this object
pub async fn endpoints_agents_connectors_check_in_create(configuration: &configuration::Configuration, device_facts_request: Option<models::DeviceFactsRequest>) -> Result<(), Error<EndpointsAgentsConnectorsCheckInCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// Mixin to add a used_by endpoint to return a list of all objects using this object
pub async fn endpoints_agents_connectors_create(configuration: &configuration::Configuration, agent_connector_request: models::AgentConnectorRequest) -> Result<models::AgentConnector, Error<EndpointsAgentsConnectorsCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::AgentConnector`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::AgentConnector`")))),
        }
    } else {
        let content = resp.text().await?;
...
/// Mixin to add a used_by endpoint to return a list of all objects using this object
pub async fn endpoints_agents_connectors_destroy(configuration: &configuration::Configuration, connector_uuid: &str) -> Result<(), Error<EndpointsAgentsConnectorsDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_connector_uuid = connector_uuid;

    let uri_str = format!("{}/endpoints/agents/connectors/{connector_uuid}/", configuration.base_path, connector_uuid=crate::apis::urlencode(p_path_connector_uuid));
...
/// Mixin to add a used_by endpoint to return a list of all objects using this object
pub async fn endpoints_agents_connectors_enroll_create(configuration: &configuration::Configuration, enroll_request: models::EnrollRequest) -> Result<models::AgentTokenResponse, Error<EndpointsAgentsConnectorsEnrollCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// Mixin to add a used_by endpoint to return a list of all objects using this object
pub async fn endpoints_agents_connectors_list(configuration: &configuration::Configuration, enabled: Option<bool>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>) -> Result<models::PaginatedAgentConnectorList, Error<EndpointsAgentsConnectorsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn endpoints_agents_connectors_mdm_config_create(configuration: &configuration::Configuration, connector_uuid: &str, mdm_config_request: models::MdmConfigRequest) -> Result<models::MdmConfigResponse, Error<EndpointsAgentsConnectorsMdmConfigCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_connector_uuid = connector_uuid;
    let p_body_mdm_config_request = mdm_config_request;

    let uri_str = format!("{}/endpoints/agents/connectors/{connector_uuid}/mdm_config/", configuration.base_path, connector_uuid=crate::apis::urlencode(p_path_connector_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
/// Mixin to add a used_by endpoint to return a list of all objects using this object
pub async fn endpoints_agents_connectors_partial_update(configuration: &configuration::Configuration, connector_uuid: &str, patched_agent_connector_request: Option<models::PatchedAgentConnectorRequest>) -> Result<models::AgentConnector, Error<EndpointsAgentsConnectorsPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_connector_uuid = connector_uuid;
...
/// Mixin to add a used_by endpoint to return a list of all objects using this object
pub async fn endpoints_agents_connectors_retrieve(configuration: &configuration::Configuration, connector_uuid: &str) -> Result<models::AgentConnector, Error<EndpointsAgentsConnectorsRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_connector_uuid = connector_uuid;
...
/// Mixin to add a used_by endpoint to return a list of all objects using this object
pub async fn endpoints_agents_connectors_update(configuration: &configuration::Configuration, connector_uuid: &str, agent_connector_request: models::AgentConnectorRequest) -> Result<models::AgentConnector, Error<EndpointsAgentsConnectorsUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_connector_uuid = connector_uuid;
    let p_body_agent_connector_request = agent_connector_request;
...
pub async fn endpoints_agents_connectors_used_by_list(configuration: &configuration::Configuration, connector_uuid: &str) -> Result<Vec<models::UsedBy>, Error<EndpointsAgentsConnectorsUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_connector_uuid = connector_uuid;

    let uri_str = format!("{}/endpoints/agents/connectors/{connector_uuid}/used_by/", configuration.base_path, connector_uuid=crate::apis::urlencode(p_path_connector_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
/// Mixin to add a used_by endpoint to return a list of all objects using this object
pub async fn endpoints_agents_enrollment_tokens_create(configuration: &configuration::Configuration, enrollment_token_request: models::EnrollmentTokenRequest) -> Result<models::EnrollmentToken, Error<EndpointsAgentsEnrollmentTokensCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::EnrollmentToken`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::EnrollmentToken`")))),
        }
    } else {
        let content = resp.text().await?;
...
/// Mixin to add a used_by endpoint to return a list of all objects using this object
pub async fn endpoints_agents_enrollment_tokens_destroy(configuration: &configuration::Configuration, token_uuid: &str) -> Result<(), Error<EndpointsAgentsEnrollmentTokensDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_token_uuid = token_uuid;

    let uri_str = format!("{}/endpoints/agents/enrollment_tokens/{token_uuid}/", configuration.base_path, token_uuid=crate::apis::urlencode(p_path_token_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// Mixin to add a used_by endpoint to return a list of all objects using this object
pub async fn endpoints_agents_enrollment_tokens_list(configuration: &configuration::Configuration, connector: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>, token_uuid: Option<&str>) -> Result<models::PaginatedEnrollmentTokenList, Error<EndpointsAgentsEnrollmentTokensListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// Mixin to add a used_by endpoint to return a list of all objects using this object
pub async fn endpoints_agents_enrollment_tokens_partial_update(configuration: &configuration::Configuration, token_uuid: &str, patched_enrollment_token_request: Option<models::PatchedEnrollmentTokenRequest>) -> Result<models::EnrollmentToken, Error<EndpointsAgentsEnrollmentTokensPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_token_uuid = token_uuid;
...
/// Mixin to add a used_by endpoint to return a list of all objects using this object
pub async fn endpoints_agents_enrollment_tokens_retrieve(configuration: &configuration::Configuration, token_uuid: &str) -> Result<models::EnrollmentToken, Error<EndpointsAgentsEnrollmentTokensRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_token_uuid = token_uuid;
...
/// Mixin to add a used_by endpoint to return a list of all objects using this object
pub async fn endpoints_agents_enrollment_tokens_update(configuration: &configuration::Configuration, token_uuid: &str, enrollment_token_request: models::EnrollmentTokenRequest) -> Result<models::EnrollmentToken, Error<EndpointsAgentsEnrollmentTokensUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_token_uuid = token_uuid;
    let p_body_enrollment_token_request = enrollment_token_request;
...
/// Get a list of all objects that use this object
pub async fn endpoints_agents_enrollment_tokens_used_by_list(configuration: &configuration::Configuration, token_uuid: &str) -> Result<Vec<models::UsedBy>, Error<EndpointsAgentsEnrollmentTokensUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_token_uuid = token_uuid;

    let uri_str = format!("{}/endpoints/agents/enrollment_tokens/{token_uuid}/used_by/", configuration.base_path, token_uuid=crate::apis::urlencode(p_path_token_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn endpoints_agents_enrollment_tokens_view_key_retrieve(configuration: &configuration::Configuration, token_uuid: &str) -> Result<models::TokenView, Error<EndpointsAgentsEnrollmentTokensViewKeyRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_token_uuid = token_uuid;

    let uri_str = format!("{}/endpoints/agents/enrollment_tokens/{token_uuid}/view_key/", configuration.base_path, token_uuid=crate::apis::urlencode(p_path_token_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn endpoints_agents_psso_register_device_create(configuration: &configuration::Configuration, agent_psso_device_registration_request: models::AgentPssoDeviceRegistrationRequest) -> Result<models::AgentPssoDeviceRegistrationResponse, Error<EndpointsAgentsPssoRegisterDeviceCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn endpoints_agents_psso_register_user_create(configuration: &configuration::Configuration, agent_psso_user_registration_request: models::AgentPssoUserRegistrationRequest) -> Result<models::UserSelf, Error<EndpointsAgentsPssoRegisterUserCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::UserSelf`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::UserSelf`")))),
        }
    } else {
        let content = resp.text().await?;
...
/// Connector Viewset
pub async fn endpoints_connectors_destroy(configuration: &configuration::Configuration, connector_uuid: &str) -> Result<(), Error<EndpointsConnectorsDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_connector_uuid = connector_uuid;

    let uri_str = format!("{}/endpoints/connectors/{connector_uuid}/", configuration.base_path, connector_uuid=crate::apis::urlencode(p_path_connector_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// Connector Viewset
pub async fn endpoints_connectors_list(configuration: &configuration::Configuration, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>) -> Result<models::PaginatedConnectorList, Error<EndpointsConnectorsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ordering = ordering;
    let p_query_page = page;
    let p_query_page_size = page_size;
...
/// Connector Viewset
pub async fn endpoints_connectors_retrieve(configuration: &configuration::Configuration, connector_uuid: &str) -> Result<models::Connector, Error<EndpointsConnectorsRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_connector_uuid = connector_uuid;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::Connector`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::Connector`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn endpoints_connectors_types_list(configuration: &configuration::Configuration, ) -> Result<Vec<models::TypeCreate>, Error<EndpointsConnectorsTypesListError>> {
...
/// Get a list of all objects that use this object
pub async fn endpoints_connectors_used_by_list(configuration: &configuration::Configuration, connector_uuid: &str) -> Result<Vec<models::UsedBy>, Error<EndpointsConnectorsUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_connector_uuid = connector_uuid;

    let uri_str = format!("{}/endpoints/connectors/{connector_uuid}/used_by/", configuration.base_path, connector_uuid=crate::apis::urlencode(p_path_connector_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn endpoints_device_access_groups_create(configuration: &configuration::Configuration, device_access_group_request: models::DeviceAccessGroupRequest) -> Result<models::DeviceAccessGroup, Error<EndpointsDeviceAccessGroupsCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// DeviceAccessGroup Viewset
pub async fn endpoints_device_access_groups_destroy(configuration: &configuration::Configuration, pbm_uuid: &str) -> Result<(), Error<EndpointsDeviceAccessGroupsDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pbm_uuid = pbm_uuid;

    let uri_str = format!("{}/endpoints/device_access_groups/{pbm_uuid}/", configuration.base_path, pbm_uuid=crate::apis::urlencode(p_path_pbm_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// DeviceAccessGroup Viewset
pub async fn endpoints_device_access_groups_list(configuration: &configuration::Configuration, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, pbm_uuid: Option<&str>, search: Option<&str>) -> Result<models::PaginatedDeviceAccessGroupList, Error<EndpointsDeviceAccessGroupsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_name = name;
    let p_query_ordering = ordering;
    let p_query_page = page;
...
/// DeviceAccessGroup Viewset
pub async fn endpoints_device_access_groups_partial_update(configuration: &configuration::Configuration, pbm_uuid: &str, patched_device_access_group_request: Option<models::PatchedDeviceAccessGroupRequest>) -> Result<models::DeviceAccessGroup, Error<EndpointsDeviceAccessGroupsPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pbm_uuid = pbm_uuid;
...
/// DeviceAccessGroup Viewset
pub async fn endpoints_device_access_groups_retrieve(configuration: &configuration::Configuration, pbm_uuid: &str) -> Result<models::DeviceAccessGroup, Error<EndpointsDeviceAccessGroupsRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pbm_uuid = pbm_uuid;
...
/// DeviceAccessGroup Viewset
pub async fn endpoints_device_access_groups_update(configuration: &configuration::Configuration, pbm_uuid: &str, device_access_group_request: models::DeviceAccessGroupRequest) -> Result<models::DeviceAccessGroup, Error<EndpointsDeviceAccessGroupsUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pbm_uuid = pbm_uuid;
    let p_body_device_access_group_request = device_access_group_request;
...
/// Get a list of all objects that use this object
pub async fn endpoints_device_access_groups_used_by_list(configuration: &configuration::Configuration, pbm_uuid: &str) -> Result<Vec<models::UsedBy>, Error<EndpointsDeviceAccessGroupsUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pbm_uuid = pbm_uuid;

    let uri_str = format!("{}/endpoints/device_access_groups/{pbm_uuid}/used_by/", configuration.base_path, pbm_uuid=crate::apis::urlencode(p_path_pbm_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn endpoints_device_bindings_create(configuration: &configuration::Configuration, device_user_binding_request: models::DeviceUserBindingRequest) -> Result<models::DeviceUserBinding, Error<EndpointsDeviceBindingsCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// PolicyBinding Viewset
pub async fn endpoints_device_bindings_destroy(configuration: &configuration::Configuration, policy_binding_uuid: &str) -> Result<(), Error<EndpointsDeviceBindingsDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_policy_binding_uuid = policy_binding_uuid;

    let uri_str = format!("{}/endpoints/device_bindings/{policy_binding_uuid}/", configuration.base_path, policy_binding_uuid=crate::apis::urlencode(p_path_policy_binding_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// PolicyBinding Viewset
pub async fn endpoints_device_bindings_list(configuration: &configuration::Configuration, enabled: Option<bool>, order: Option<i32>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, policy: Option<&str>, policy__isnull: Option<bool>, search: Option<&str>, target: Option<&str>, target_in: Option<Vec<uuid::Uuid>>, timeout: Option<i32>) -> Result<models::PaginatedDeviceUserBindingList, Error<EndpointsDeviceBindingsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_enabled = enabled;
...
/// PolicyBinding Viewset
pub async fn endpoints_device_bindings_partial_update(configuration: &configuration::Configuration, policy_binding_uuid: &str, patched_device_user_binding_request: Option<models::PatchedDeviceUserBindingRequest>) -> Result<models::DeviceUserBinding, Error<EndpointsDeviceBindingsPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_policy_binding_uuid = policy_binding_uuid;
...
/// PolicyBinding Viewset
pub async fn endpoints_device_bindings_retrieve(configuration: &configuration::Configuration, policy_binding_uuid: &str) -> Result<models::DeviceUserBinding, Error<EndpointsDeviceBindingsRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_policy_binding_uuid = policy_binding_uuid;
...
/// PolicyBinding Viewset
pub async fn endpoints_device_bindings_update(configuration: &configuration::Configuration, policy_binding_uuid: &str, device_user_binding_request: models::DeviceUserBindingRequest) -> Result<models::DeviceUserBinding, Error<EndpointsDeviceBindingsUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_policy_binding_uuid = policy_binding_uuid;
    let p_body_device_user_binding_request = device_user_binding_request;
...
/// Get a list of all objects that use this object
pub async fn endpoints_device_bindings_used_by_list(configuration: &configuration::Configuration, policy_binding_uuid: &str) -> Result<Vec<models::UsedBy>, Error<EndpointsDeviceBindingsUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_policy_binding_uuid = policy_binding_uuid;

    let uri_str = format!("{}/endpoints/device_bindings/{policy_binding_uuid}/used_by/", configuration.base_path, policy_binding_uuid=crate::apis::urlencode(p_path_policy_binding_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
/// Mixin to add a used_by endpoint to return a list of all objects using this object
pub async fn endpoints_devices_destroy(configuration: &configuration::Configuration, device_uuid: &str) -> Result<(), Error<EndpointsDevicesDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_device_uuid = device_uuid;

    let uri_str = format!("{}/endpoints/devices/{device_uuid}/", configuration.base_path, device_uuid=crate::apis::urlencode(p_path_device_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// Mixin to add a used_by endpoint to return a list of all objects using this object
pub async fn endpoints_devices_list(configuration: &configuration::Configuration, identifier: Option<&str>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>) -> Result<models::PaginatedEndpointDeviceList, Error<EndpointsDevicesListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// Mixin to add a used_by endpoint to return a list of all objects using this object
pub async fn endpoints_devices_partial_update(configuration: &configuration::Configuration, device_uuid: &str, patched_endpoint_device_request: Option<models::PatchedEndpointDeviceRequest>) -> Result<models::EndpointDevice, Error<EndpointsDevicesPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_device_uuid = device_uuid;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::EndpointDevice`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::EndpointDevice`")))),
        }
    } else {
        let content = resp.text().await?;
...
/// Mixin to add a used_by endpoint to return a list of all objects using this object
pub async fn endpoints_devices_retrieve(configuration: &configuration::Configuration, device_uuid: &str) -> Result<models::EndpointDeviceDetails, Error<EndpointsDevicesRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_device_uuid = device_uuid;
...
/// Mixin to add a used_by endpoint to return a list of all objects using this object
pub async fn endpoints_devices_summary_retrieve(configuration: &configuration::Configuration, ) -> Result<models::DeviceSummary, Error<EndpointsDevicesSummaryRetrieveError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::DeviceSummary`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::DeviceSummary`")))),
        }
    } else {
        let content = resp.text().await?;
...
/// Mixin to add a used_by endpoint to return a list of all objects using this object
pub async fn endpoints_devices_update(configuration: &configuration::Configuration, device_uuid: &str, endpoint_device_request: models::EndpointDeviceRequest) -> Result<models::EndpointDevice, Error<EndpointsDevicesUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_device_uuid = device_uuid;
...
/// Get a list of all objects that use this object
pub async fn endpoints_devices_used_by_list(configuration: &configuration::Configuration, device_uuid: &str) -> Result<Vec<models::UsedBy>, Error<EndpointsDevicesUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_device_uuid = device_uuid;

    let uri_str = format!("{}/endpoints/devices/{device_uuid}/used_by/", configuration.base_path, device_uuid=crate::apis::urlencode(p_path_device_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn endpoints_fleet_connectors_create(configuration: &configuration::Configuration, fleet_connector_request: models::FleetConnectorRequest) -> Result<models::FleetConnector, Error<EndpointsFleetConnectorsCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::FleetConnector`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::FleetConnector`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<EndpointsFleetConnectorsCreateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// FleetConnector Viewset
pub async fn endpoints_fleet_connectors_destroy(configuration: &configuration::Configuration, connector_uuid: &str) -> Result<(), Error<EndpointsFleetConnectorsDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_connector_uuid = connector_uuid;

    let uri_str = format!("{}/endpoints/fleet/connectors/{connector_uuid}/", configuration.base_path, connector_uuid=crate::apis::urlencode(p_path_connector_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<EndpointsFleetConnectorsDestroyError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// FleetConnector Viewset
pub async fn endpoints_fleet_connectors_list(configuration: &configuration::Configuration, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>) -> Result<models::PaginatedFleetConnectorList, Error<EndpointsFleetConnectorsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_name = name;
    let p_query_ordering = ordering;
    let p_query_page = page;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::PaginatedFleetConnectorList`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::PaginatedFleetConnectorList`")))),
        }
    } else {
        let content = resp.text().await?;
...
/// FleetConnector Viewset
pub async fn endpoints_fleet_connectors_partial_update(configuration: &configuration::Configuration, connector_uuid: &str, patched_fleet_connector_request: Option<models::PatchedFleetConnectorRequest>) -> Result<models::FleetConnector, Error<EndpointsFleetConnectorsPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_connector_uuid = connector_uuid;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<EndpointsFleetConnectorsPartialUpdateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// FleetConnector Viewset
pub async fn endpoints_fleet_connectors_retrieve(configuration: &configuration::Configuration, connector_uuid: &str) -> Result<models::FleetConnector, Error<EndpointsFleetConnectorsRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_connector_uuid = connector_uuid;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<EndpointsFleetConnectorsRetrieveError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// FleetConnector Viewset
pub async fn endpoints_fleet_connectors_update(configuration: &configuration::Configuration, connector_uuid: &str, fleet_connector_request: models::FleetConnectorRequest) -> Result<models::FleetConnector, Error<EndpointsFleetConnectorsUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_connector_uuid = connector_uuid;
    let p_body_fleet_connector_request = fleet_connector_request;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<EndpointsFleetConnectorsUpdateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Get a list of all objects that use this object
pub async fn endpoints_fleet_connectors_used_by_list(configuration: &configuration::Configuration, connector_uuid: &str) -> Result<Vec<models::UsedBy>, Error<EndpointsFleetConnectorsUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_connector_uuid = connector_uuid;

    let uri_str = format!("{}/endpoints/fleet/connectors/{connector_uuid}/used_by/", configuration.base_path, connector_uuid=crate::apis::urlencode(p_path_connector_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn endpoints_google_chrome_connectors_create(configuration: &configuration::Configuration, google_chrome_connector_request: models::GoogleChromeConnectorRequest) -> Result<models::GoogleChromeConnector, Error<EndpointsGoogleChromeConnectorsCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// GoogleChromeConnector Viewset
pub async fn endpoints_google_chrome_connectors_destroy(configuration: &configuration::Configuration, connector_uuid: &str) -> Result<(), Error<EndpointsGoogleChromeConnectorsDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_connector_uuid = connector_uuid;

    let uri_str = format!("{}/endpoints/google_chrome/connectors/{connector_uuid}/", configuration.base_path, connector_uuid=crate::apis::urlencode(p_path_connector_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
/// GoogleChromeConnector Viewset
pub async fn endpoints_google_chrome_connectors_list(configuration: &configuration::Configuration, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, search: Option<&str>) -> Result<models::PaginatedGoogleChromeConnectorList, Error<EndpointsGoogleChromeConnectorsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_name = name;
    let p_query_ordering = ordering;
    let p_query_page = page;
...
/// GoogleChromeConnector Viewset
pub async fn endpoints_google_chrome_connectors_partial_update(configuration: &configuration::Configuration, connector_uuid: &str, patched_google_chrome_connector_request: Option<models::PatchedGoogleChromeConnectorRequest>) -> Result<models::GoogleChromeConnector, Error<EndpointsGoogleChromeConnectorsPartialUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_connector_uuid = connector_uuid;
...
/// GoogleChromeConnector Viewset
pub async fn endpoints_google_chrome_connectors_retrieve(configuration: &configuration::Configuration, connector_uuid: &str) -> Result<models::GoogleChromeConnector, Error<EndpointsGoogleChromeConnectorsRetrieveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_connector_uuid = connector_uuid;
...
/// GoogleChromeConnector Viewset
pub async fn endpoints_google_chrome_connectors_update(configuration: &configuration::Configuration, connector_uuid: &str, google_chrome_connector_request: models::GoogleChromeConnectorRequest) -> Result<models::GoogleChromeConnector, Error<EndpointsGoogleChromeConnectorsUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_connector_uuid = connector_uuid;
    let p_body_google_chrome_connector_request = google_chrome_connector_request;
...
/// Get a list of all objects that use this object
pub async fn endpoints_google_chrome_connectors_used_by_list(configuration: &configuration::Configuration, connector_uuid: &str) -> Result<Vec<models::UsedBy>, Error<EndpointsGoogleChromeConnectorsUsedByListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_connector_uuid = connector_uuid;

    let uri_str = format!("{}/endpoints/google_chrome/connectors/{connector_uuid}/used_by/", configuration.base_path, connector_uuid=crate::apis::urlencode(p_path_connector_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
