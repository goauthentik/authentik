...
export function instanceOfProxyOutpostConfig(value: object): value is ProxyOutpostConfig {
    ...
    if ((!('oidcConfiguration' in (value as Record<string, any>)) && !('oidc_configuration' in (value as Record<string, any>))) || ((value as Record<string, any>)['oidcConfiguration'] === undefined && (value as Record<string, any>)['oidc_configuration'] === undefined)) return false;
    if ((!('accessTokenValidity' in (value as Record<string, any>)) && !('access_token_validity' in (value as Record<string, any>))) || ((value as Record<string, any>)['accessTokenValidity'] === undefined && (value as Record<string, any>)['access_token_validity'] === undefined)) return false;
    if ((!('scopesToRequest' in (value as Record<string, any>)) && !('scopes_to_request' in (value as Record<string, any>))) || ((value as Record<string, any>)['scopesToRequest'] === undefined && (value as Record<string, any>)['scopes_to_request'] === undefined)) return false;
...
export function ProxyOutpostConfigToJSONTyped(value?: Omit<ProxyOutpostConfig, 'pk'|'oidcConfiguration'|'accessTokenValidity'|'scopesToRequest'|'assignedApplicationSlug'|'assignedApplicationName'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
