...
export function DeviceUserBindingToJSONTyped(value?: Omit<DeviceUserBinding, 'pk'|'policyObj'|'groupObj'|'userObj'|'expires'|'expiring'|'connector'|'connectorObj'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
