...
export function UserToJSONTyped(value?: Omit<User, 'pk'|'date_joined'|'is_superuser'|'groups_obj'|'roles_obj'|'avatar'|'uid'|'uuid'|'password_change_date'|'last_updated'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
