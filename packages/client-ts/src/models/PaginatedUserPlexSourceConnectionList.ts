 ...
 */
export function instanceOfPaginatedUserPlexSourceConnectionList(
    value: object,
): value is PaginatedUserPlexSourceConnectionList {
...
export function PaginatedUserPlexSourceConnectionListFromJSON(
    json: any,
): PaginatedUserPlexSourceConnectionList {
    return PaginatedUserPlexSourceConnectionListFromJSONTyped(json, false);
}

export function PaginatedUserPlexSourceConnectionListFromJSONTyped(
    json: any,
...
export function PaginatedUserPlexSourceConnectionListToJSON(
    json: any,
): PaginatedUserPlexSourceConnectionList {
    return PaginatedUserPlexSourceConnectionListToJSONTyped(json, false);
}

export function PaginatedUserPlexSourceConnectionListToJSONTyped(
    value?: PaginatedUserPlexSourceConnectionList | null,
