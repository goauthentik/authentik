...
export function instanceOfIdentificationChallenge(value: object): value is IdentificationChallenge {
    if ((!('userFields' in (value as Record<string, any>)) && !('user_fields' in (value as Record<string, any>))) || ((value as Record<string, any>)['userFields'] === undefined && (value as Record<string, any>)['user_fields'] === undefined)) return false;
    if ((!('passwordFields' in (value as Record<string, any>)) && !('password_fields' in (value as Record<string, any>))) || ((value as Record<string, any>)['passwordFields'] === undefined && (value as Record<string, any>)['password_fields'] === undefined)) return false;
    if ((!('flowDesignation' in (value as Record<string, any>)) && !('flow_designation' in (value as Record<string, any>))) || ((value as Record<string, any>)['flowDesignation'] === undefined && (value as Record<string, any>)['flow_designation'] === undefined)) return false;
    if ((!('primaryAction' in (value as Record<string, any>)) && !('primary_action' in (value as Record<string, any>))) || ((value as Record<string, any>)['primaryAction'] === undefined && (value as Record<string, any>)['primary_action'] === undefined)) return false;
    if ((!('showSourceLabels' in (value as Record<string, any>)) && !('show_source_labels' in (value as Record<string, any>))) || ((value as Record<string, any>)['showSourceLabels'] === undefined && (value as Record<string, any>)['show_source_labels'] === undefined)) return false;
    return true;
}
...
export function IdentificationChallengeFromJSONTyped(json: any, ignoreDiscriminator: boolean): IdentificationChallenge {
    ...
    return {
        ...
        'pendingUserIdentifier': json['pending_user_identifier'] === undefined ? undefined : json['pending_user_identifier'] === null ? null : json['pending_user_identifier'],
        ...
        'captchaStage': json['captcha_stage'] === undefined ? undefined : json['captcha_stage'] === null ? null : CaptchaChallengeFromJSON(json['captcha_stage']),
        ...
        'passkeyChallenge': json['passkey_challenge'] === undefined ? undefined : json['passkey_challenge'] === null ? null : json['passkey_challenge'],
    };
}
