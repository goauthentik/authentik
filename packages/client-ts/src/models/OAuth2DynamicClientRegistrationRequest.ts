 ...
 */
export function instanceOfOAuth2DynamicClientRegistrationRequest(value: object): value is OAuth2DynamicClientRegistrationRequest {
    if (!('provider' in value) || value['provider'] === undefined) return false;
    return true;
}

export function OAuth2DynamicClientRegistrationRequestFromJSON(json: any): OAuth2DynamicClientRegistrationRequest {
    return OAuth2DynamicClientRegistrationRequestFromJSONTyped(json, false);
}

export function OAuth2DynamicClientRegistrationRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): OAuth2DynamicClientRegistrationRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function OAuth2DynamicClientRegistrationRequestToJSON(json: any): OAuth2DynamicClientRegistrationRequest {
    return OAuth2DynamicClientRegistrationRequestToJSONTyped(json, false);
}

export function OAuth2DynamicClientRegistrationRequestToJSONTyped(value?: OAuth2DynamicClientRegistrationRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
