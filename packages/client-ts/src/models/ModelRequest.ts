...
export function ModelRequestToJSONTyped(value?: ModelRequest | null, ignoreDiscriminator: boolean = false): any {
    ...
    switch (value['providerModel']) {
        case 'authentik_providers_google_workspace.googleworkspaceprovider':
            return Object.assign({}, GoogleWorkspaceProviderRequestToJSON(value), { 'provider_model': 'authentik_providers_google_workspace.googleworkspaceprovider' } as const);
        case 'authentik_providers_ldap.ldapprovider':
            return Object.assign({}, LDAPProviderRequestToJSON(value), { 'provider_model': 'authentik_providers_ldap.ldapprovider' } as const);
        case 'authentik_providers_microsoft_entra.microsoftentraprovider':
            return Object.assign({}, MicrosoftEntraProviderRequestToJSON(value), { 'provider_model': 'authentik_providers_microsoft_entra.microsoftentraprovider' } as const);
        case 'authentik_providers_oauth2.oauth2provider':
            return Object.assign({}, OAuth2ProviderRequestToJSON(value), { 'provider_model': 'authentik_providers_oauth2.oauth2provider' } as const);
        case 'authentik_providers_proxy.proxyprovider':
            return Object.assign({}, ProxyProviderRequestToJSON(value), { 'provider_model': 'authentik_providers_proxy.proxyprovider' } as const);
        case 'authentik_providers_rac.racprovider':
            return Object.assign({}, RACProviderRequestToJSON(value), { 'provider_model': 'authentik_providers_rac.racprovider' } as const);
        case 'authentik_providers_radius.radiusprovider':
            return Object.assign({}, RadiusProviderRequestToJSON(value), { 'provider_model': 'authentik_providers_radius.radiusprovider' } as const);
        case 'authentik_providers_saml.samlprovider':
            return Object.assign({}, SAMLProviderRequestToJSON(value), { 'provider_model': 'authentik_providers_saml.samlprovider' } as const);
        case 'authentik_providers_scim.scimprovider':
            return Object.assign({}, SCIMProviderRequestToJSON(value), { 'provider_model': 'authentik_providers_scim.scimprovider' } as const);
        case 'authentik_providers_ssf.ssfprovider':
            return Object.assign({}, SSFProviderRequestToJSON(value), { 'provider_model': 'authentik_providers_ssf.ssfprovider' } as const);
        case 'authentik_providers_ws_federation.wsfederationprovider':
            return Object.assign({}, WSFederationProviderRequestToJSON(value), { 'provider_model': 'authentik_providers_ws_federation.wsfederationprovider' } as const);
        default:
            return value;
    }
}
