...
export function AuthenticatorStaticStageToJSONTyped(value?: Omit<AuthenticatorStaticStage, 'pk'|'component'|'verboseName'|'verboseNamePlural'|'metaModelName'|'flowSet'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
