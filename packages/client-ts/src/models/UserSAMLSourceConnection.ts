...
export function UserSAMLSourceConnectionToJSONTyped(value?: Omit<UserSAMLSourceConnection, 'pk'|'user'|'sourceObj'|'created'|'lastUpdated'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
