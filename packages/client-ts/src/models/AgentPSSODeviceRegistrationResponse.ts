...
export function instanceOfAgentPSSODeviceRegistrationResponse(value: object): value is AgentPSSODeviceRegistrationResponse {
    ...
    if ((!('jwksEndpoint' in (value as Record<string, any>)) && !('jwks_endpoint' in (value as Record<string, any>))) || ((value as Record<string, any>)['jwksEndpoint'] === undefined && (value as Record<string, any>)['jwks_endpoint'] === undefined)) return false;
    if (!('audience' in value) || value['audience'] === undefined) return false;
    if ((!('nonceEndpoint' in (value as Record<string, any>)) && !('nonce_endpoint' in (value as Record<string, any>))) || ((value as Record<string, any>)['nonceEndpoint'] === undefined && (value as Record<string, any>)['nonce_endpoint'] === undefined)) return false;
    return true;
}
