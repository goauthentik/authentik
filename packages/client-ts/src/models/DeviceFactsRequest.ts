...
export function DeviceFactsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeviceFactsRequest {
    ...
    return {
        ...
        'os': json['os'] === undefined ? undefined : json['os'] === null ? null : OperatingSystemRequestFromJSON(json['os']),
        'disks': json['disks'] === undefined ? undefined : json['disks'] === null ? null : ((json['disks'] as Array<any>).map(DiskRequestFromJSON)),
        'network': json['network'] === undefined ? undefined : json['network'] === null ? null : NetworkRequestFromJSON(json['network']),
        'hardware': json['hardware'] === undefined ? undefined : json['hardware'] === null ? null : HardwareRequestFromJSON(json['hardware']),
        'software': json['software'] === undefined ? undefined : json['software'] === null ? null : ((json['software'] as Array<any>).map(SoftwareRequestFromJSON)),
        'processes': json['processes'] === undefined ? undefined : json['processes'] === null ? null : ((json['processes'] as Array<any>).map(ProcessRequestFromJSON)),
        'users': json['users'] === undefined ? undefined : json['users'] === null ? null : ((json['users'] as Array<any>).map(DeviceUserRequestFromJSON)),
        'groups': json['groups'] === undefined ? undefined : json['groups'] === null ? null : ((json['groups'] as Array<any>).map(DeviceGroupRequestFromJSON)),
