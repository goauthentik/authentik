...
export function KerberosSourcePropertyMappingToJSONTyped(value?: Omit<KerberosSourcePropertyMapping, 'pk'|'component'|'verboseName'|'verboseNamePlural'|'metaModelName'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
