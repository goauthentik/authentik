...
export function PlexSourceToJSONTyped(value?: Omit<PlexSource, 'pk'|'component'|'verboseName'|'verboseNamePlural'|'metaModelName'|'managed'|'iconUrl'|'iconThemedUrls'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
