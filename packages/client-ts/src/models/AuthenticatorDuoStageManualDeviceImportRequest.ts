...
export function instanceOfAuthenticatorDuoStageManualDeviceImportRequest(value: object): value is AuthenticatorDuoStageManualDeviceImportRequest {
    if ((!('duoUserId' in (value as Record<string, any>)) && !('duo_user_id' in (value as Record<string, any>))) || ((value as Record<string, any>)['duoUserId'] === undefined && (value as Record<string, any>)['duo_user_id'] === undefined)) return false;
