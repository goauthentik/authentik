...
export function GroupOAuthSourceConnectionToJSONTyped(value?: Omit<GroupOAuthSourceConnection, 'pk'|'group'|'sourceObj'|'created'|'lastUpdated'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
