...
export function GroupPlexSourceConnectionToJSONTyped(value?: Omit<GroupPlexSourceConnection, 'pk'|'group'|'sourceObj'|'created'|'lastUpdated'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
