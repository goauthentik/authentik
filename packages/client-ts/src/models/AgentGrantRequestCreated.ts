...
/**
 * Response to an agent's access request: the request it created, plus the URL to hand to the human
 * it acts for. An agent has no browser, so it cannot run the approval itself -- `fulfill_url` is
 * what its owner opens to approve or deny.
 *
 * @export
