...
import {
    ...
    NotificationModeEnumFromJSONTyped,
    NotificationModeEnumToJSON,
    NotificationModeEnumToJSONTyped,
 ...
 */
export function instanceOfPatchedRequestRuleRequest(value: object): value is PatchedRequestRuleRequest {
    return true;
}
...
export function PatchedRequestRuleRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PatchedRequestRuleRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function PatchedRequestRuleRequestToJSONTyped(value?: PatchedRequestRuleRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
