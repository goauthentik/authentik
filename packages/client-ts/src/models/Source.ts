...
export function SourceToJSONTyped(value?: Omit<Source, 'pk'|'component'|'verboseName'|'verboseNamePlural'|'metaModelName'|'managed'|'iconUrl'|'iconThemedUrls'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
