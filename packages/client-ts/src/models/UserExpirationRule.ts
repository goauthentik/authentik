...
export function UserExpirationRuleFromJSON(json: any): UserExpirationRule {
    return UserExpirationRuleFromJSONTyped(json, false);
}

export function UserExpirationRuleFromJSONTyped(
    json: any,
...
export function UserExpirationRuleToJSON(json: any): UserExpirationRule {
    return UserExpirationRuleToJSONTyped(json, false);
}
