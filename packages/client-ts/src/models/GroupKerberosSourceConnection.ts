...
export function GroupKerberosSourceConnectionToJSONTyped(value?: Omit<GroupKerberosSourceConnection, 'pk'|'group'|'sourceObj'|'created'|'lastUpdated'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
