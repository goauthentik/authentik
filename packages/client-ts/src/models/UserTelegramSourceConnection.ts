...
export function UserTelegramSourceConnectionToJSONTyped(value?: Omit<UserTelegramSourceConnection, 'pk'|'user'|'sourceObj'|'created'|'lastUpdated'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
