...
export function TaskToJSONTyped(value?: Omit<Task, 'rel_obj_app_label'|'rel_obj_model'|'uid'|'logs'|'previous_logs'|'description'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
