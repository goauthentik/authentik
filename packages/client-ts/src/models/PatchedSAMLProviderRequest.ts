...
export interface PatchedSAMLProviderRequest {
    ...
    audience?: string;
    /**
     * Also known as EntityID. Providing a value overrides the default issuer generated by
     * authentik.
     */
     ...
     * iframes. Front-channel native uses your active browser tab to send post requests and redirect
     * to providers. Back-channel sends logout requests directly from the server without user
     * interaction (requires POST SLS binding).
     */
 ...
 */
export function instanceOfPatchedSAMLProviderRequest(
    value: object,
): value is PatchedSAMLProviderRequest {
    return true;
}
...
export function PatchedSAMLProviderRequestFromJSONTyped(
    json: any,
...
export function PatchedSAMLProviderRequestToJSON(json: any): PatchedSAMLProviderRequest {
    return PatchedSAMLProviderRequestToJSONTyped(json, false);
}

export function PatchedSAMLProviderRequestToJSONTyped(
    value?: PatchedSAMLProviderRequest | null,
