...
export function instanceOfBrand(value: object): value is Brand {
    if ((!('brandUuid' in (value as Record<string, any>)) && !('brand_uuid' in (value as Record<string, any>))) || ((value as Record<string, any>)['brandUuid'] === undefined && (value as Record<string, any>)['brand_uuid'] === undefined)) return false;
...
export function BrandToJSONTyped(value?: Omit<Brand, 'brandUuid'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
