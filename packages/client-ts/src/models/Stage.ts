...
export function StageToJSONTyped(value?: Omit<Stage, 'pk'|'component'|'verboseName'|'verboseNamePlural'|'metaModelName'|'flowSet'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
