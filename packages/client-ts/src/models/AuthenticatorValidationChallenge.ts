...
export function instanceOfAuthenticatorValidationChallenge(value: object): value is AuthenticatorValidationChallenge {
    ...
    if ((!('deviceChallenges' in (value as Record<string, any>)) && !('device_challenges' in (value as Record<string, any>))) || ((value as Record<string, any>)['deviceChallenges'] === undefined && (value as Record<string, any>)['device_challenges'] === undefined)) return false;
    if ((!('configurationStages' in (value as Record<string, any>)) && !('configuration_stages' in (value as Record<string, any>))) || ((value as Record<string, any>)['configurationStages'] === undefined && (value as Record<string, any>)['configuration_stages'] === undefined)) return false;
    return true;
}
