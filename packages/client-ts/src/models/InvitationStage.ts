...
export function InvitationStageToJSONTyped(value?: Omit<InvitationStage, 'pk'|'component'|'verboseName'|'verboseNamePlural'|'metaModelName'|'flowSet'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
