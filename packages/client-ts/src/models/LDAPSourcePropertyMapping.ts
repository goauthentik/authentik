...
export function LDAPSourcePropertyMappingToJSONTyped(value?: Omit<LDAPSourcePropertyMapping, 'pk'|'component'|'verboseName'|'verboseNamePlural'|'metaModelName'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
