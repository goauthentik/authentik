...
export function IdentificationChallengeResponseRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): IdentificationChallengeResponseRequest {
    ...
    return {
        ...
        'uidField': json['uid_field'] === undefined ? undefined : json['uid_field'] === null ? null : json['uid_field'],
        'password': json['password'] === undefined ? undefined : json['password'] === null ? null : json['password'],
        'captchaToken': json['captcha_token'] === undefined ? undefined : json['captcha_token'] === null ? null : json['captcha_token'],
