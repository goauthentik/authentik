...
export function UserKerberosSourceConnectionToJSONTyped(value?: Omit<UserKerberosSourceConnection, 'pk'|'user'|'sourceObj'|'created'|'lastUpdated'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
