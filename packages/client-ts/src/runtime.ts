...
export class BaseAPI {
    ...
    /**
     * Create a shallow clone of `this` by constructing a new instance and then shallow cloning data
     * members.
     */
 ...
 *
 * `format: date` is a calendar date, with no time and no offset, so it is converted against the
 * local calendar on both ends: they have to agree or the date shifts by a day. `format: date-time`
 * is an instant and uses UTC.
 */
