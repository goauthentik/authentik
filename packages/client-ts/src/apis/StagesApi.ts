...
import {
    type PaginatedUserSelectionStageList,
    PaginatedUserSelectionStageListFromJSON,
} from "../models/PaginatedUserSelectionStageList";
import {
...
import {
    type PatchedUserSelectionStageRequest,
    PatchedUserSelectionStageRequestToJSON,
} from "../models/PatchedUserSelectionStageRequest";
import {
...
import { type UserSelectionStage, UserSelectionStageFromJSON } from "../models/UserSelectionStage";
import {
    type UserSelectionStageRequest,
    UserSelectionStageRequestToJSON,
} from "../models/UserSelectionStageRequest";
...
export interface StagesUserSelectionSelectionCreateRequest {
    userSelectionStageRequest: UserSelectionStageRequest;
}

export interface StagesUserSelectionSelectionDestroyRequest {
    stageUuid: string;
}

export interface StagesUserSelectionSelectionListRequest {
    name?: string;
    ordering?: string;
    page?: number;
    pageSize?: number;
...
export interface StagesUserSelectionSelectionPartialUpdateRequest {
    stageUuid: string;
    patchedUserSelectionStageRequest?: PatchedUserSelectionStageRequest;
}

export interface StagesUserSelectionSelectionRetrieveRequest {
    stageUuid: string;
}

export interface StagesUserSelectionSelectionUpdateRequest {
    stageUuid: string;
    userSelectionStageRequest: UserSelectionStageRequest;
}

export interface StagesUserSelectionSelectionUsedByListRequest {
    stageUuid: string;
}
...
export class StagesApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for stagesUserSelectionSelectionCreate without sending the request
     */
    async stagesUserSelectionSelectionCreateRequestOpts(
        requestParameters: StagesUserSelectionSelectionCreateRequest,
    ): Promise<runtime.RequestOpts> {
        if (requestParameters["userSelectionStageRequest"] == null) {
            throw new runtime.RequiredError(
                "userSelectionStageRequest",
                'Required parameter "userSelectionStageRequest" was null or undefined when calling stagesUserSelectionSelectionCreate().',
            );
        }
        ...
        let urlPath = `/stages/user_selection/selection/`;
        ...
        return {
            ...
            headers: headerParameters,
            query: queryParameters,
            body: UserSelectionStageRequestToJSON(requestParameters["userSelectionStageRequest"]),
        };
    }
     ...
     */
    async stagesUserSelectionSelectionCreateRaw(
        requestParameters: StagesUserSelectionSelectionCreateRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<runtime.ApiResponse<UserSelectionStage>> {
        const requestOptions =
            await this.stagesUserSelectionSelectionCreateRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) =>
            UserSelectionStageFromJSON(jsonValue),
        );
    }
     ...
     * UserSelectionStage viewset.
     */
    async stagesUserSelectionSelectionCreate(
        requestParameters: StagesUserSelectionSelectionCreateRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<UserSelectionStage> {
        const response = await this.stagesUserSelectionSelectionCreateRaw(
            requestParameters,
            initOverrides,
        );
        return await response.value();
    ...
    /**
     * Creates request options for stagesUserSelectionSelectionDestroy without sending the request
     */
    async stagesUserSelectionSelectionDestroyRequestOpts(
        requestParameters: StagesUserSelectionSelectionDestroyRequest,
    ): Promise<runtime.RequestOpts> {
        if (requestParameters["stageUuid"] == null) {
            throw new runtime.RequiredError(
                "stageUuid",
                'Required parameter "stageUuid" was null or undefined when calling stagesUserSelectionSelectionDestroy().',
            );
        }
        ...
        let urlPath = `/stages/user_selection/selection/{stage_uuid}/`;
        urlPath = urlPath.replace(
            "{stage_uuid}",
            encodeURIComponent(String(requestParameters["stageUuid"])),
        );
     ...
     * UserSelectionStage viewset.
     */
    async stagesUserSelectionSelectionDestroyRaw(
        requestParameters: StagesUserSelectionSelectionDestroyRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<runtime.ApiResponse<void>> {
        const requestOptions =
            await this.stagesUserSelectionSelectionDestroyRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
     ...
     * UserSelectionStage viewset.
     */
    async stagesUserSelectionSelectionDestroy(
        requestParameters: StagesUserSelectionSelectionDestroyRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<void> {
        await this.stagesUserSelectionSelectionDestroyRaw(requestParameters, initOverrides);
    }

    /**
     * Creates request options for stagesUserSelectionSelectionList without sending the request
     */
    async stagesUserSelectionSelectionListRequestOpts(
        requestParameters: StagesUserSelectionSelectionListRequest,
    ): Promise<runtime.RequestOpts> {
        const queryParameters: any = {};
     ...
     * UserSelectionStage viewset.
     */
    async stagesUserSelectionSelectionListRaw(
        requestParameters: StagesUserSelectionSelectionListRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<runtime.ApiResponse<PaginatedUserSelectionStageList>> {
        const requestOptions =
            await this.stagesUserSelectionSelectionListRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) =>
            PaginatedUserSelectionStageListFromJSON(jsonValue),
        );
    }
     ...
     * UserSelectionStage viewset.
     */
    async stagesUserSelectionSelectionList(
        requestParameters: StagesUserSelectionSelectionListRequest = {},
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<PaginatedUserSelectionStageList> {
        const response = await this.stagesUserSelectionSelectionListRaw(
            requestParameters,
            initOverrides,
        );
        return await response.value();
    ...
    /**
     * Creates request options for stagesUserSelectionSelectionPartialUpdate without sending the request
     */
    async stagesUserSelectionSelectionPartialUpdateRequestOpts(
        requestParameters: StagesUserSelectionSelectionPartialUpdateRequest,
    ): Promise<runtime.RequestOpts> {
        if (requestParameters["stageUuid"] == null) {
            throw new runtime.RequiredError(
                "stageUuid",
                'Required parameter "stageUuid" was null or undefined when calling stagesUserSelectionSelectionPartialUpdate().',
            );
        }
        ...
        return {
            ...
            headers: headerParameters,
            query: queryParameters,
            body: PatchedUserSelectionStageRequestToJSON(
                requestParameters["patchedUserSelectionStageRequest"],
            ),
        };
    }
     ...
     * UserSelectionStage viewset.
     */
    async stagesUserSelectionSelectionPartialUpdateRaw(
        requestParameters: StagesUserSelectionSelectionPartialUpdateRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<runtime.ApiResponse<UserSelectionStage>> {
        const requestOptions =
            await this.stagesUserSelectionSelectionPartialUpdateRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
     ...
     * UserSelectionStage viewset.
     */
    async stagesUserSelectionSelectionPartialUpdate(
        requestParameters: StagesUserSelectionSelectionPartialUpdateRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<UserSelectionStage> {
        const response = await this.stagesUserSelectionSelectionPartialUpdateRaw(
            requestParameters,
            initOverrides,
        );
        return await response.value();
    ...
    /**
     * Creates request options for stagesUserSelectionSelectionRetrieve without sending the request
     */
    async stagesUserSelectionSelectionRetrieveRequestOpts(
        requestParameters: StagesUserSelectionSelectionRetrieveRequest,
    ): Promise<runtime.RequestOpts> {
        if (requestParameters["stageUuid"] == null) {
            throw new runtime.RequiredError(
                "stageUuid",
                'Required parameter "stageUuid" was null or undefined when calling stagesUserSelectionSelectionRetrieve().',
            );
        }
     ...
     * UserSelectionStage viewset.
     */
    async stagesUserSelectionSelectionRetrieveRaw(
        requestParameters: StagesUserSelectionSelectionRetrieveRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<runtime.ApiResponse<UserSelectionStage>> {
        const requestOptions =
            await this.stagesUserSelectionSelectionRetrieveRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
     ...
     * UserSelectionStage viewset.
     */
    async stagesUserSelectionSelectionRetrieve(
        requestParameters: StagesUserSelectionSelectionRetrieveRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<UserSelectionStage> {
        const response = await this.stagesUserSelectionSelectionRetrieveRaw(
            requestParameters,
            initOverrides,
        );
        return await response.value();
    ...
    /**
     * Creates request options for stagesUserSelectionSelectionUpdate without sending the request
     */
    async stagesUserSelectionSelectionUpdateRequestOpts(
        requestParameters: StagesUserSelectionSelectionUpdateRequest,
    ): Promise<runtime.RequestOpts> {
        if (requestParameters["stageUuid"] == null) {
            throw new runtime.RequiredError(
                "stageUuid",
                'Required parameter "stageUuid" was null or undefined when calling stagesUserSelectionSelectionUpdate().',
            );
        }
        ...
        if (requestParameters["userSelectionStageRequest"] == null) {
            throw new runtime.RequiredError(
                "userSelectionStageRequest",
                'Required parameter "userSelectionStageRequest" was null or undefined when calling stagesUserSelectionSelectionUpdate().',
            );
        }
     ...
     * UserSelectionStage viewset.
     */
    async stagesUserSelectionSelectionUpdateRaw(
        requestParameters: StagesUserSelectionSelectionUpdateRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<runtime.ApiResponse<UserSelectionStage>> {
        const requestOptions =
            await this.stagesUserSelectionSelectionUpdateRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
     ...
     * UserSelectionStage viewset.
     */
    async stagesUserSelectionSelectionUpdate(
        requestParameters: StagesUserSelectionSelectionUpdateRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<UserSelectionStage> {
        const response = await this.stagesUserSelectionSelectionUpdateRaw(
            requestParameters,
            initOverrides,
        );
        return await response.value();
    ...
    /**
     * Creates request options for stagesUserSelectionSelectionUsedByList without sending the request
     */
    async stagesUserSelectionSelectionUsedByListRequestOpts(
        requestParameters: StagesUserSelectionSelectionUsedByListRequest,
    ): Promise<runtime.RequestOpts> {
        if (requestParameters["stageUuid"] == null) {
            throw new runtime.RequiredError(
                "stageUuid",
                'Required parameter "stageUuid" was null or undefined when calling stagesUserSelectionSelectionUsedByList().',
            );
        }
        ...
        let urlPath = `/stages/user_selection/selection/{stage_uuid}/used_by/`;
        urlPath = urlPath.replace(
            "{stage_uuid}",
            encodeURIComponent(String(requestParameters["stageUuid"])),
        );
     ...
     * Get a list of all objects that use this object
     */
    async stagesUserSelectionSelectionUsedByListRaw(
        requestParameters: StagesUserSelectionSelectionUsedByListRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<runtime.ApiResponse<Array<UsedBy>>> {
        const requestOptions =
            await this.stagesUserSelectionSelectionUsedByListRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
     ...
     * Get a list of all objects that use this object
     */
    async stagesUserSelectionSelectionUsedByList(
        requestParameters: StagesUserSelectionSelectionUsedByListRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<Array<UsedBy>> {
        const response = await this.stagesUserSelectionSelectionUsedByListRaw(
            requestParameters,
            initOverrides,
        );
        return await response.value();
