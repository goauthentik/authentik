...
sidebar_custom_props:
    resourceName: Monitor System Performance
...
1. **Distinctio name**: Libero tempore cum soluta nobis est eligendi
2. **Option cumque**: Nihil impedit quo minus id quod maxime
