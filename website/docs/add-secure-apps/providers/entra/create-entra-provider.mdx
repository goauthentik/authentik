...
4. On the **New Microsoft Entra Provider** page, set the following configurations:
    ...
    - Under **Protocol settings**:
        ...
        - **User deletion action**: controls what happens in Entra ID when a user is deleted from authentik. Defaults to **Delete**. See [Deletion and offboarding](./index.mdx#deletion-and-offboarding) for the available actions and their effects
        - **Group deletion action**: controls what happens in Entra ID when a group is deleted from authentik. Defaults to **Delete**. See [Deletion and offboarding](./index.mdx#deletion-and-offboarding) for the available actions and their effects
