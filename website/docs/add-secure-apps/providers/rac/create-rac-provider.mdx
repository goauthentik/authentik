...
4. On the Provider page, under **Endpoints**, click **New RAC Endpoint**, and provide the following settings:
    ...
    - **Advanced settings _(optional)_**: define other connection settings to be used. For more information, refer to the [Connection settings](./index.mdx#connection-settings) documentation
