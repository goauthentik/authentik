...
The service account must have access to the LDAP application. If the application uses application bindings, add the service account to an appropriate binding.
