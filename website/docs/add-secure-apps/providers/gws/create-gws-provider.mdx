...
4. On the **New Google Workspace Provider** page, set the following configurations:
    ...
    - Under **Protocol settings**:
        ...
        - **Group deletion action**: controls what happens in Google Workspace when a group is deleted from authentik. Defaults to **Delete**. See [Deletion and offboarding](./index.mdx#deletion-and-offboarding) for the available actions and their effects
