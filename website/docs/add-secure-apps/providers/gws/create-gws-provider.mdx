...
4. On the **New Google Workspace Provider** page, set the following configurations:
    ...
    - Under **Protocol settings**:
        - **Credentials**: create or select a secret containing the JSON file that you downloaded when [configuring Google Workspace](./configure-gws.mdx). Use the **File** type to upload it, or **Multi-line text** to paste its contents.
