...
To create a Google Workspace provider in authentik, you must have already [configured Google Workspace](../../add-secure-apps/providers/gws/setup-gws.md) to integrate with authentik.
