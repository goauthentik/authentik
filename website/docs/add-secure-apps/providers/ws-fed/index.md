...
| Endpoint                  | URL                                                          |
| ------------------------- | ------------------------------------------------------------ |
| SSO (Redirect binding)    | `/application/ws-fed/<application_slug>/sso/binding/redirect/` |
...
| SLO (Redirect binding)    | `/application/ws-fed/<application_slug>/slo/binding/redirect/` |
