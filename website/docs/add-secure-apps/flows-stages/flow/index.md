...
Download our [Example flows](../add-secure-apps/flows-stages/flow/examples/flows.md) and then import them into your authentik instance.
...
After creating the flow, you can then [bind specific stages](../flow/stages/index.md#bind-a-stage-to-a-flow) to the flow and [bind policies](../customize/policies/working_with_policies/working_with_policies.md) to the flow to further customize the user's log in and authentication process.
