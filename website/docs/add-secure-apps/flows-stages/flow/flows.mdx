---
title: Example flows
description: Import example flow blueprints for enrollment, MFA login, magic links, and other workflows.
sidebar_position: 5
---
...
<<<<<<<< HEAD:website/docs/add-secure-apps/flows-stages/flow/examples/flows.md
...
>>>>>>>> ff40a9f9c (website/docs: flows-stages: update section (#25640)):website/docs/add-secure-apps/flows-stages/flow/flows.mdx
