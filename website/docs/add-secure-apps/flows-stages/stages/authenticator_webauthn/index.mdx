...
The order of selected hints matters: earlier hints have higher priority. For example, selecting "Security key" first and "Hybrid" second tells the browser to prefer security keys but offer hybrid as a fallback.
