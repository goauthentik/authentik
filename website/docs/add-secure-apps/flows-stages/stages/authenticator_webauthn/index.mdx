...
To share credentials such as passkeys across brands served on different domains, see [Share passkeys across brands (Related Origin Requests)](./related-origin-requests.mdx).
