...
- **Failed attempts before lockout** :ak-enterprise Lock password login after this many consecutive failed password attempts. Set this option to `0` to disable password lockout.
