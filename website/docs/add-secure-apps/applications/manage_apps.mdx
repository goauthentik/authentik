...
2. bind a user or group to the application.
...
To bind a user or group to an application, click on an application in the applications list, click the **Policy/Group/User Bindings** tab, select **Group** or **User** from the **Policy/Group/User Bindings** options, and then select the group or user.
