...
After installation, the chart outputs an example kubeconfig file. Store this file as an authentik secret and select it when configuring the remote connection:
...
4. Beside the **Kubeconfig** selector, click **Create secret**. Upload the kubeconfig as a **File** secret, or paste its YAML into a **Multi-line text** secret.
