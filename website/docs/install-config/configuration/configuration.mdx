...
- `AUTHENTIK_POSTGRESQL__DEFAULT_SCHEMA`: Specifies the PostgreSQL schema name to use for authentik data. If not specified, defalts to `public`. :ak-version[2024.12]
