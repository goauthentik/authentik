...
The same variables power administrator notifications, release and configuration alerts, [notification rules](../../sys-mgmt/events/notifications.md), and any Email stage configured to use global settings.
