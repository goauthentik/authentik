...
List of comma-separated address:port for HTTP.
...
List of comma-separated address:port for HTTPS.
...
List of comma-separated address:port for LDAP.
...
List of comma-separated address:port for LDAPS.
...
List of comma-separated address:port for Prometheus metrics.
