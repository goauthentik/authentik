...
:::info Deprecated
This setting is deprecated as of version 2025.4. Sessions are now exclusively stored in the database. See our [2025.4 release notes](https://version-2025-4.goauthentik.io/docs/releases/2025.4#sessions-are-now-stored-in-the-database) for more information.
:::
