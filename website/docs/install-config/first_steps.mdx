...
<details>
    <summary>We'll use Grafana as a first application.</summary>
...
Every application that you add to authentik requires a provider, which serves as a secure communication bridge between the application and authentik using standardized protocols like OIDC, SAML, LDAP, or others.
:::
