...
After you have downloaded the `docker-compose.yml` file, generated your generate a password and a secret key, and optionally configured your global email, run these commands to retrieve and install the current version of authentik:
