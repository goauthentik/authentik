...
- Assign your new user to appropriate [groups](../../users-sources/user/user_basic_operations.md#add-a-user-to-a-group) and [roles](../../users-sources/user/user_basic_operations.md#add-a-user-to-a-role).
    - Learn more about [RBAC in authentik](../../users-sources/access-control/index.mdx), including how to [restrict access](../../add-secure-apps/applications/manage_apps.mdx#use-bindings-to-control-access) to an application. See more below in [#using-bindings-to-allow-or-restrict-access-to-applications](#)
