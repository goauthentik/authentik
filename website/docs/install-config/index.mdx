...
The installation process is the same for the open-source edition and [authentik Enterprise](../enterprise/index.md). To enable Enterprise features, [install an Enterprise license](../enterprise/install-license.md) after installing authentik.
