...
If you're configuring authentik to send email via an SMTP server that has TLS enabled you must mount the authenticating certificate in your authentik worker and server containers:
