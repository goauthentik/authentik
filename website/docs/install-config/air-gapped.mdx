...
| https://www.gravatar.com                 | Avatar checks by authentik and image loads by the browser | Set **Avatars** to `initials` in [System settings](../sys-mgmt/settings.mdx)                  |
...
Complete the initial setup from your installation guide. In the Admin interface, open [System settings](../sys-mgmt/settings.mdx) and set **Avatars** to `initials` to stop authentik and browsers from requesting Gravatar images.
