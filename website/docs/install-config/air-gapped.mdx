...
authentik deployments require access to the following container images. In an air-gapped environment, this can be achieved by mirroring the containers to an internal registry, or using other methods appropriate for your environment.
...
- **LDAP Outpost**: Port 3389 (LDAP) and 6636 (LDAPS)
