...
Review the target version's [release notes](/releases/) and [back up your deployment](../sys-mgmt/ops/backup-restore.mdx) before upgrading. Download the updated Compose file or Helm chart on a connected system and mirror all required images for the target release, including any changed supporting-service images.
