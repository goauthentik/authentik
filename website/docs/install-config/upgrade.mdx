...
**Database backup**: Before upgrading, make a backup of your PostgreSQL database. You can create a backup by dumping your existing database. For detailed instructions, refer to the relevant guide for your deployment method ([Docker Compose](../troubleshooting/infrastructure/docker/postgres-upgrade.mdx) or [Kubernetes](../troubleshooting/infrastructure/kubernetes/postgres-upgrade.mdx)).
