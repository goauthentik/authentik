---
title: Collecting and Viewing Logs
description: Adjust authentik log levels and retrieve recent output to troubleshoot deployments.
tags:
    - troubleshooting
    - logging
    - diagnostics
...
2. Navigate to **Applications** > **Outposts** and click the **Edit** icon next to your outpost.
3. Under **Advanced settings**, set the `log_level` field to the desired log level.
4. Click **Update**.
...
1. Log in to authentik as an administrator and open the authentik Admin interface.
2. Navigate to **Applications** > **Outposts** and click the **Edit** icon next to your outpost.
3. Under **Advanced settings**, set the `log_level` field to `trace`.
4. Click **Update**.
