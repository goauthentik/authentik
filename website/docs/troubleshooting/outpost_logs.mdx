...
This guide only applies to standalone outposts, the [Embedded outpost](../add-secure-apps/outposts/embedded/embedded.mdx) outputs logs to the usual [authentik logs](./logs.mdx).
