...
description: Upgrade the authentik PostgreSQL container safely by backing up data and recreating the service.
tags:
    - troubleshooting
    - infrastructure
    - docker
    - postgres
keywords:
    - authentik postgres upgrade
    - docker compose database upgrade
