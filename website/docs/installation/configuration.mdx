...
### `AUTHENTIK_DEFAULT_TOKEN_DURATION`

:::info
Requires authentik 2024.1.0
:::

Configure the default duration of generated tokens. Defaults to `minutes=30`. Format is `days=10;hours=1;minute=3;seconds=5`.
