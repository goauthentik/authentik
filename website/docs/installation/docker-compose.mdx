...
<Tabs groupId="OS">
    ...
    <TabItem value="Windows" label="Windows">
        ...
        echo PG_PASS=$([System.Web.Security.Membership]::GeneratePassword(50,20)) >> .env
        echo AUTHENTIK_SECRET_KEY=$([System.Web.Security.Membership]::GeneratePassword(50,20)) >> .env
        ```
    </TabItem>
</Tabs>
