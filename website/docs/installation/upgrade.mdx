...
<Tabs groupId="platform">
  <TabItem value="docker-compose" label="Docker Compose" default>
    ...
    ßDownload the `docker-compose.yml` file using either `wget -O docker-compose.yml https://goauthentik.io/docker-compose.yml` or `curl -O https://goauthentik.io/docker-compose.yml`or a similar process.
