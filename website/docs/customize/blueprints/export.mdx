...
A specific flow with it's attached stages, policies, and other objects can be exported.

This export can be triggered via the API or the Web UI by clicking the **Export** button (download icon) next to the flow in the flow list.
