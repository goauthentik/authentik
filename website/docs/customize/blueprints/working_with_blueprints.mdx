...
3. Choose how to import the blueprint:
    ...
    - **Local path**: select one of the blueprints available on the authentik server, such as a bundled [example flow](../../add-secure-apps/flows-stages/flow/examples/flows.mdx).
4. Click **Import**.
...
1. Download one of the [example flows](../../add-secure-apps/flows-stages/flow/examples/flows.mdx).
