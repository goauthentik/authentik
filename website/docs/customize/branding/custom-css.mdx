...
The authentik interface supports [multiple languages and regional settings](../../developer-docs/translation.mdx). Depending on the detected locale and your instance's localization settings, the interface may adjust text direction (left-to-right or right-to-left), date formats, and other locale-specific elements.
