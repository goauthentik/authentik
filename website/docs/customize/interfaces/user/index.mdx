...
The User interface can be customized using attributes configured in [Brands](../../../customize/branding/index.mdx).
...
#### `settings.enabledFeatures.requests` :ak-enterprise (User interface only)

When configured, show the requests tab on the user interface to allow users to request access to applications.
