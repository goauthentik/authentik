...
- Default background image for all flows, set in the instance's [brand](../../../customize/branding/index.mdx)
- A background image for [one or more specific flows](../../../add-secure-apps/flows-stages/flow/index.mdx#flow-configuration-options) (overrides the default)
