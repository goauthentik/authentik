...
- If a file exists at `/data/media/public/branding/logo.svg`, enter `branding/logo.svg` in the picker field. Do not enter `/data/media/public/branding/logo.svg` or `/branding/logo.svg`.
