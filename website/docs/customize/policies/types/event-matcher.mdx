...
This policy is most commonly used with [Notification Rules](../../../sys-mgmt/events/notifications.mdx).
...
2. Create or edit a [Notification Rule](../../../sys-mgmt/events/notifications.mdx).
