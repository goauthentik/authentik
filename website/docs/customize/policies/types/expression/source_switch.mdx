...
[Create an expression policy](../../working_with_policies.mdx#create-a-policy) that:
...
For more background on binding policies to stages, see [Working with policies](../../working_with_policies.mdx#bind-a-policy-to-a-stage-binding).
