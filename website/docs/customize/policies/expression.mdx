...
-   `request`: A PolicyRequest object, which has the following properties:
    ...
    -   `request.user`: The current user, against which the policy is applied. See [User](../../users-sources/user/user_ref.md#object-properties)
...
-   `context['pending_user']`: The currently pending user, see [User](../../users-sources/user/user_ref.md#object-properties)
