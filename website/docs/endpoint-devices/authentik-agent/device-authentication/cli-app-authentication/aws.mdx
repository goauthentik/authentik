...
<<<<<<< HEAD:website/docs/endpoint-devices/device-authentication/cli-app-authentication/aws.mdx
...
>>>>>>> 95233dd9f (website/docs: endpoint devices: update device authentication location (#20049)):website/docs/endpoint-devices/authentik-agent/device-authentication/cli-app-authentication/aws.mdx
