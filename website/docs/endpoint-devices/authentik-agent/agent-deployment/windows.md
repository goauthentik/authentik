...
5. Click **Create**.
6. _(Optional)_ Click the **Copy** icon in the **Actions** column. You need this value to [enable device compliance](#enable-device-compliance-and-local-device-login).
...
5. After the download completes, install the MSI file.
