...
4. _(optional)_ If you plan to enable [SSH server authentication and local device login](#join-the-device-to-an-authentik-domain), you will need to install two additional packages:
...
3. _(optional)_ If you plan to enable [SSH server authentication and local device login](#join-the-device-to-an-authentik-domain), you will need to install two additional packages:
