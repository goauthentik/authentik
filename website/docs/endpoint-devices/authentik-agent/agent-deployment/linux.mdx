...
5. Click **Create**.
6. _(Optional)_ Click the **Copy** icon in the **Actions** column. You need this value to [enable device compliance](#enable-device-compliance-ssh-server-authentication-and-local-device-login).
...
4. _(Optional)_ To enable [SSH server authentication and local device login](#enable-device-compliance-ssh-server-authentication-and-local-device-login), install two additional packages:
...
3. _(Optional)_ To enable [SSH server authentication and local device login](#enable-device-compliance-ssh-server-authentication-and-local-device-login), install two additional packages:
