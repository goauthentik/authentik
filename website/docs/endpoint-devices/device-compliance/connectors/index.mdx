...
- [authentik Agent connector](./authentik-agent.mdx): Integrates with the [authentik Agent](../../authentik-agent/index.mdx)
- [Fleet connector](./fleetdm.mdx): Integrates with [Fleet](https://fleetdm.com/) device management
...
For more specific instructions on adding a connector refer to the [authentik Agent connector](./authentik-agent.mdx) or [Fleet connector](./fleetdm.mdx) documentation.
