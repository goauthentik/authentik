...
- [Configure authentik to support the authentik Agent](../authentik-agent/configuration.mdx).
...
Now that the endpoint device is configured, you can create [device compliance policies](./device-compliance-policy.mdx) to control access to applications and more.
