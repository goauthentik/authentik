...
1. Open Edge.
2. Go to the the [authentik Endpoint SSO browser extension page](https://microsoftedge.microsoft.com/addons/detail/authentik-endpoint-sso/mcmjmlcifgadhpeggocghbiainhedbgn) on the Edge Add-ons site.
3. Click **Get**.
4. Review the permissions and click **Add Extension**.
