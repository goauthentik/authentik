...
| **authentik Agent and Fleet Connectors** | Open source    | Open source ?  | Open source ?    | Available for early preview.                                                                        |
| **Other Connectors** (Entra, Intune etc) | :ak-enterprise | :ak-enterprise | :ak-enterprise   | In development.                                                                                     |
