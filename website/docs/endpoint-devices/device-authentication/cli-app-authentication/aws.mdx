...
You can use the authentik Agent to authenticate to AWS CLI with authentik credentials.
...
To authenticate to AWS CLI with the authentik agent, use the following command:
...
-e, --region string Region (default "eu-central-1")
-r, --role-arn string Role ARN
-h, --help help for aws
