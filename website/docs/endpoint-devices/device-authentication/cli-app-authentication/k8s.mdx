...
tags: [authentik Agent, authentik cli, kubernetes, k8s, kubeadm, cli]
---
...
To support the integration of authentik Agent with Kubernetes, you need to create an application/provider pair in authentik.
