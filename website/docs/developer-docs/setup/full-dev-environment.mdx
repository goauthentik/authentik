...
import InstallScriptsAdmonition from "./_install-scripts-admonition.mdx";
...
- [pnpm](https://pnpm.io/installation) (11.25 or later), the package manager used across every JavaScript workspace in the repository
...
:::info
nvm runs on macOS and Linux; on Windows, use [nvm-windows](https://github.com/coreybutler/nvm-windows), a separate project with its own command set.
:::
