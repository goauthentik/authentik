...
- [pnpm](https://pnpm.io/installation) (11.9 or later), the package manager used across every JavaScript workspace in the repository. Install it directly, or run `corepack enable pnpm` to have Node.js manage the version pinned in `package.json`.
