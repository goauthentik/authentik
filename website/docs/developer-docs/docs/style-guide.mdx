...
- **authentik icons**:
    - For authentik icons in integration guides, reference assets from the user's own self-hosted instance to avoid external calls: `https://authentik.company/static/dist/assets/icons/icon.svg`
