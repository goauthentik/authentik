...
## Documentation deployment locations

authentik documentation is deployed to multiple domains based on different git branches:

| Domain                                             | Git Branch       | Description                      |
| -------------------------------------------------- | ---------------- | -------------------------------- |
