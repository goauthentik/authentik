...
:::info
Please review the [Writing documentation](./docs/writing-documentation.mdx) guidelines as they apply to documentation too.
:::
...
- [pnpm](https://pnpm.io/installation) (11.25 or later), installed by following the [pnpm installation guide](https://pnpm.io/installation)
