...
- **Reputation score limit**: The defaults for the new upper and lower limits on Reputation score are `-5` and `5`. This might break custom policies that rely on the reputation scores decreasing or increasing beyond these limits. You can set your custom limits under **System > Settings**.
