...
- **Fixed behavior in Source stage :ak-enterprise**
...
- **SSF Provider** :ak-enterprise :ak-preview
    ...
    [Shared Signals Framework](../../add-secure-apps/providers/ssf/index.mdx) allows applications to register a stream with authentik through which they can receive events from authentik, such as when a session is revoked or a credential is added, changed, or deleted, and execute actions based on these events.
...
- **GeoIP distance and impossible travel checks**
    ...
    These options can be used to detect and prevent access from potentially stolen authentik sessions or stolen devices. Refer to our [documentation](../../customize/policies/types/geoip.mdx).
...
- **Email OTP Authenticator Setup Stage**
    ...
    See [Email Authenticator Setup Stage](../../add-secure-apps/flows-stages/stages/authenticator_email/index.mdx).
...
- **Improved debugging experience**
    ...
    For people developing authentik or building very complex, custom integrations, how to configure debugging in authentik is documented [here](../../developer-docs/setup/debugging.mdx).
