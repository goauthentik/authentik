...
- **LDAP source sync forward deletions**: This option synchronizes the deletion of users or groups (those created by LDAP sources) in authentik when they are removed in the LDAP source.
