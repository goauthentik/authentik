...
- **Docker image deprecation notice for `beryju/authentik` and `beryju/authentik-*`**
    ...
    **Outpost images:**
    ...
    We recommend updating your Docker Compose files, Kubernetes deployments, or other container configurations to use these new image paths for consistency with our documentation.
