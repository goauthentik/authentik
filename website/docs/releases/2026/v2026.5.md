...
- The Jellyseerr integration guide was updated for the project's move to [Seerr](https://integrations.goauthentik.io/media/seerr/), with redirects from the old guide path. (Thanks to @BreizhHardware)
