...
Endpoints now has a FleetDM connector integration. You can now pull in device facts and signals data from Fleet into authentik to implement Conditional Access rules. For more information, see [Fleet connector.](../../endpoint-devices/device-compliance/connectors/fleetdm.md)
