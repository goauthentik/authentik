...
Bootstrap and API password hash imports now enforce the [password hash import policy](../../core/password-hashes.mdx#password-hash-import-policy). Existing stored hashes and blueprint imports are unchanged.
