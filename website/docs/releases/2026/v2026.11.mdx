...
Providers, sources, stages, and connectors reference [Secret](../../sys-mgmt/secrets/index.mdx) objects to store credentials such as:
...
Manage secrets used by providers, sources, stages, and connectors under **System** > **Secrets**. Grant access to view or rotate a credential separately from permission to edit the object that uses it. You can reuse a secret across objects and create one directly from a referencing form. Viewing a value and rotating it are audited.
