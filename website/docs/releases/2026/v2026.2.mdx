...
[Object Lifecycle Management](../../sys-mgmt/object-lifecycle-management.mdx) allows Admins to schedule and track periodic reviews for Applications, Groups, and Roles. Reviewing access privileges to specific applications is an important best practice, as is reviewing other settings such as your branding settings, group and role membership, application entitlements, and current policy bindings.
...
For details refer to our [WS-Federation provider documentation](../../add-secure-apps/providers/wsfed/index.mdx).

### Endpoints and authentik agent :ak-enterprise

Endpoints now has a [Fleet connector](../../endpoint-devices/device-compliance/connectors/fleetdm.mdx) integration. You can now pull device facts and signals data from [Fleet](https://fleetdm.com/) into authentik to implement Conditional Access rules.

[Local Device Login](../../endpoint-devices/authentik-agent/device-authentication/local-device-login/linux.mdx) now works on Linux too and also supports webauthn/FIDO2.
...
:::warning Compose file name change
Starting with 2026.2, we renamed the file from docker-compose.yml to compose.yml. Look over your old docker-compose.yml file and make any changes to the new compose.yml before deleting your old docker-compose.yml.
:::

To upgrade, download the new compose file and update the Docker stack with the new version, using these commands:

```shell
wget -O compose.yml https://goauthentik.io/version/2026.2/lifecycle/container/compose.yml
docker compose up -d
```
...
- admin/files: sign custom-domain S3 URLs for the final host (cherry-pick #21704 to version-2026.2) (#23008)
- core: preserve encoded avatar URLs (cherry-pick #23225 to version-2026.2) (#23393)
- endpoints/connectors/agent: fix exception with invalid auth type (cherry-pick #22943 to version-2026.2) (#22950)
- packages/django-dramatiq-postgres/broker: fix race condition in broker causing completed tasks to be repeated (cherry-pick #23218 to version-2026.2) (#23258)
- policies: skip cache invalidation on User last_login update (cherry-pick #23159 to version-2026.2) (#23426)
- providers/\*: fix missing declaration for can_discover for outgoing sync providers (cherry-pick #23035 to version-2026.2) (#23232)
- providers/ldap: remove incorrect validation for code authenticator extraction (cherry-pick #23006 to version-2026.2) (#23766)
- providers/radius: fix panic in log due to type (cherry-pick #22965 to version-2026.2) (#22966)
- providers/scim: account for users with no email during discovery (cherry-pick #23417 to version-2026.2) (#23771)
- providers/SCIM: Add discover support (cherry-pick #20658 to version-2026.2) (#23776)
- providers/scim: allow failures during discovery (cherry-pick #23357 to version-2026.2) (#23772)
- root: in-process per-IP rate throttle (#23015) (2026.2) (#23774)
- stages/captcha: fix hcaptcha height (#20901) (2026.2) (#23775)
- tasks/schedules: fix paused schedules getting unpaused on startup (cherry-pick #23521 to version-2026.2) (#23526)
- web: Fix issue where default user path is not preferred. (cherry-pick #22139 to version-2026.2) (#22457)
- web/flows: fix race condition in continuous login and support source stages in authentication flows (cherry-pick #23049 to version-2026.2) (#23557)

## Fixed in 2026.2.6

- lib/sync/outgoing: fix discover running for each page (cherry-pick #24016 to version-2026.2) (#24018)
- packages/django-dramatiq-postgres/broker: close unusable PostgreSQL connections (cherry-pick #24023 to version-2026.2) (#24034)
- security: automated internal backport of patch 1817.sec.patch to authentik-2026.2 (#24053)
- security: automated internal backport of patch 1822.sec.patch to authentik-2026.2 (#24054)
- security: automated internal backport of patch 1887.sec.patch to authentik-2026.2 (#24055)
- security: automated internal backport of patch 1919.sec.patch to authentik-2026.2 (#24056)
- security: automated internal backport of patch 1934.sec.patch to authentik-2026.2 (#24057)
- sources/oauth: improve id_token validation for apple source (cherry-pick #24017 to version-2026.2) (#24021)
- tests/openid_conformance: migrate to upstream images (cherry-pick #23828 to version-2026.2) (#23835)

## Fixed in 2026.2.7

- core: bump django from 5.2.16 to v5.2.17 (cherry-pick #24793 to version-2026.2) (#24817)
- core: return the intended status code from error views for all request methods (cherry-pick #24902 to version-2026.2) (#24956)
- lib: avoid DNS resolution in fqdn_rand (cherry-pick #25728 to version-2026.2) (#25759)
- lifecycle/container: drop curl and runit (cherry-pick #24008 to version-2026.2) (#24113)
- policies: filter policy engine (cherry-pick #24025 to version-2026.2) (#24169)
- providers/scim: fix scim changed detection for nested attributes (cherry-pick #24332 to version-2026.2) (#24443)
- rbac: use constant-time comparison in SecretKeyFilter (cherry-pick #24888 to version-2026.2) (#24946)
- security: automated internal backport of patch 1751-secrets-read-permission.sec.patch to authentik-2026.2 (#25955)
- security: automated internal backport of patch 1877-group-hierarchy-roles.sec.patch to authentik-2026.2 (#25956)
- security: automated internal backport of patch 1914-saml.sec.patch to authentik-2026.2 (#25957)
- security: automated internal backport of patch 2032-authenticator-email-recipient-override.sec.patch to authentik-2026.2 (#25958)
- security: automated internal backport of patch 2190-libxml2-doctype.sec.patch to authentik-2026.2 (#25959)
- server/core: handle unsupported HTTP method (cherry-pick #22498 to version-2026.2) (#25363)
- stages/identification: dynamic captcha keys when stage embedded in identification stage (cherry-pick #24079 to version-2026.2) (#25499)
