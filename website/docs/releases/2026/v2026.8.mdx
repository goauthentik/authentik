...
- blueprints Add `EQ` and `NEQ` modes to the `!Condition` tag (cherry-pick #20315 to version-2026.8) (#24842)
...
- web/elements: fix prioritization in form serialization for dotted input-fields (cherry-pick #24987 to version-2026.8) (#24996)
...
- web/user: fix request access URL from agent not working (cherry-pick #25113 to version-2026.8) (#25118)
