...
- (Kubernetes only) Changes to RBAC objects created by helm
    ...
    To keep the old behavior, you can install the [authentik-remote-cluster](https://artifacthub.io/packages/helm/goauthentik/authentik-remote-cluster) chart, which deploys the same RBAC into any other namespace or cluster.
...
- RADIUS support
    ...
    The RADIUS provider also uses a flow to authenticate users, and supports the same stages as the [LDAP Provider](../../add-secure-apps/providers/ldap/index.mdx).
...
- Prompt preview
    ...
    When creating a single prompt for use with a [Prompt stage](../../add-secure-apps/flows-stages/stages/prompt/index.mdx), a live preview of the prompt is now shown. This makes it easier to test how a prompt will behave, and also shows what data it will send, and how it will be available in the flow context.
...
- security: Address pen-test findings from the [2023-06 Cure53 Code audit](../../security/audits-and-certs/2023-06-cure53.mdx)

## Fixed in 2023.4.3

- \*: fix [CVE-2023-36456](../../security/cves/CVE-2023-36456.mdx), Reported by [@thijsa](https://github.com/thijsa)
