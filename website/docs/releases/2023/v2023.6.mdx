...
- LDAP StartTLS support
    ...
    authentik's [LDAP Provider](../../add-secure-apps/providers/ldap/index.mdx) now supports StartTLS in addition to supporting SSL. The StartTLS is a more modern method of encrypting LDAP traffic. With this added support, the LDAP [Outpost](../../add-secure-apps/outposts/index.mdx) can now support multiple certificates.
