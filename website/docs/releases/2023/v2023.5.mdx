...
- Backchannel providers
    ...
    Backchannel providers can augment the functionality of applications by using additional protocols. The main provider of an application provides the SSO protocol that is used for logging into the application. Then, additional backchannel providers can be used for protocols such as [SCIM](../../add-secure-apps/providers/scim/index.mdx) and [LDAP](../../add-secure-apps/providers/ldap/index.mdx) to provide directory syncing.
...
- \*: fix [CVE-2023-39522](../../security/cves/CVE-2023-39522.mdx), Reported by [@markrassamni](https://github.com/markrassamni)
