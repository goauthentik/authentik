...
- web/elements: fix pagination page button colors in dark mode
...
- \*: fix [CVE-2023-26481](../../security/cves/CVE-2023-26481.mdx), Reported by [@fuomag9](https://github.com/fuomag9)
