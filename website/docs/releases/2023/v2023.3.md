...
- Theming improvements
    ...
    - The custom.css file is now loaded in ShadowDOMs, allowing for much greater customization, as previously it was only possible to style elements outside of the ShadowDOM. See docs for [Flows](../../customize/interfaces/flow/customization.mdx) and the [User and Admin interfaces](../../customize/interfaces/user-admin/customization.mdx).
