...
- Removal of PostgreSQL 11 support
    ...
    For Kubernetes install, a manual one-time migration has to be done: [Upgrading PostgreSQL on Kubernetes](../../troubleshooting/infrastructure/kubernetes/postgres-upgrade.mdx)
...
This release changes the PostgreSQL dependency to require Version 12 or later, which only affects Kubernetes installs. See [here](../../troubleshooting/infrastructure/kubernetes/postgres-upgrade.mdx) for more info on upgrading.
