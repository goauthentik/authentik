...
- Twitter Source has been migrated to OAuth2
    ...
    This requires some reconfiguration on both Twitter's and authentik's side. Check out the new Twitter integration docs [here](../../users-sources/sources/social-logins/twitter/index.mdx).
...
- LDAP Outpost cached binding
    ...
    See [LDAP provider](../../add-secure-apps/providers/ldap/index.mdx#cached-bind)
