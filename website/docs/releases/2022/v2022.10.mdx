...
- Support for OAuth2 Device flow
    ...
    See more in the OAuth2 provider docs [here](../../add-secure-apps/providers/oauth2/device_code.mdx). This flow allows users to authenticate on devices that have limited input possibilities and or no browser access.
...
- \*: fix [CVE-2022-46145](../../security/cves/CVE-2022-46145.mdx), Reported by [@sdimovv](https://github.com/sdimovv)
...
- \*: fix [CVE-2022-46172](../../security/cves/CVE-2022-46172.mdx), Reported by [@DreamingRaven](https://github.com/DreamingRaven)
- \*: fix [CVE-2022-23555](../../security/cves/CVE-2022-23555.mdx), Reported by [@fuomag9](https://github.com/fuomag9)
