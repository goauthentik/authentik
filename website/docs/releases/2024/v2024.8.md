...
-   **Terraform Resource rename**
    ...
    Several resources in the terraform provider have been renamed to be more sensible. This mainly applies to Property-mapping-related resources. With the version 2024.8.1 of the terraform provider, both the old and new resources are available, and resources can be moved to the new name using `terraform state mv`.
