...
-   **SAML Source encryption support**
    ...
    It is now possible to configure a SAML Source to decrypt and validate encrypted assertions. This can be configured by certaing a [Certificate-keypair](../../sys-mgmt/certificates.md) and selecting it in the SAML Source.
