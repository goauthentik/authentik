...
-   **OAuth and SAML sources now sync groups by default**
    ...
    SAML sources now sync groups by default when data is available. TODO: what data? no clue, don't know saml, will see when implementing
...
-   **Source property mappings for LDAP, SCIM, OAuth, SAML sources**
