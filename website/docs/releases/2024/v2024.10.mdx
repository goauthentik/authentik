...
- internal: restore /ping behavior for embedded outpost (#11568)
- policies/event_matcher: fix inconsistent behavior (#11724)
...
- security: fix [CVE-2024-52287](../../security/cves/CVE-2024-52287.mdx), reported by [@matt1097](https://github.com/matt1097) (#12117)
