...
- **Tenants have been renamed to brands**
    ...
    For more information, refer to the [documentation for _brands_](../../customize/branding/index.mdx).
...
- **Session location and network binding**
    ...
    Configuration steps are available [here](../../add-secure-apps/flows-stages/stages/user_login/index.mdx#configuration-options).

- **S3 file storage**

    Media files can be stored on S3. Follow the [setup guide](../../sys-mgmt/ops/storage-s3/index.mdx) to get started.
...
- **LDAP provider: allow overriding gidNumber**
    ...
    Previously, the `gidNumber` attribute on a user was set to the same as `uidNumber`. You can now override this behavior.

- **LDAP source: new command to check connectivity**

    Examples on how to use are available [here](../../troubleshooting/ldap_source.mdx).
...
- flows: fix mismatched redirect behavior for invalid and valid flows (cherry-pick #8794) (#8796)
...
- security: fix [CVE-2024-37905](../../security/cves/CVE-2024-37905.mdx), reported by [@m2a2](https://github.com/m2a2) (cherry-pick #10230) (#10238)
- security: fix [CVE-2024-38371](../../security/cves/CVE-2024-38371.mdx), reported by Stefan Zwanenburg (cherry-pick #10229) (#10235)
