...
The provided Compose file was updated with PostgreSQL 16. You can follow the procedure [here](../../troubleshooting/infrastructure/docker/postgres-upgrade.mdx) to upgrade.
...
With this release, authentik now requires PostgreSQL version 14 or later. We recommend upgrading to the latest version if needed. Follow the instructions [here](../../troubleshooting/infrastructure/docker/postgres-upgrade.mdx) if you need to upgrade PostgreSQL with docker-compose.
