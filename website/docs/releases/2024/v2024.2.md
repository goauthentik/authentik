...
To try the release candidate out, replace your Docker image tag with the latest release candidate number, such as 2024.2.0-rc1. You can find the latest one in [the latest releases on GitHub](https://github.com/goauthentik/authentik/releases). If you don't find any, it means we haven't released one yet.
:::::
