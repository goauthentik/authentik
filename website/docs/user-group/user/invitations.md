...
Invitations are another way to create a user, by inviting someone to join your authentik instance, as a new user.
...
Click **Save** to save the new invitation and close the modal.
