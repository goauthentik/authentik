...
[authentik platform](https://github.com/goauthentik/platform) currently allows you to authenticate to Linux servers via SSH and CLI applications such as `kubectl` and `aws`.
