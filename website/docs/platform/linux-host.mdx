...
3. Click **Create**.
4. In the **Actions** column next to the newly created token, click the **Copy token** icon. Securely store the token as it will be required when configuring Platformt on your Linux host.
