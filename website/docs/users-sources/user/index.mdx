...
To learn more about Enterprise licenses with internal and external users, refer to [Manage Enterprise licensing](../../enterprise/manage-enterprise.md#about-users-and-licenses).
