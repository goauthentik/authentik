...
To view your own settings (or as an administrator, to view another user's settings) click the gear icon in the upper right. The following sections are displayed on the page:
