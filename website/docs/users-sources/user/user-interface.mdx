...
To view your own settings (or as an admin, to view another user's settings) click the gear icon in the upper right. The following sections are displayed on the page:
...
You can view applications that are configured to use the Consent stage, and which you consented to allow authentik to share your profile user data with the application.
