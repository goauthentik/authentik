...
These bindings control which users can access an application, and whether or not the application is visible in the **User Dashboard**. If no bindings for an application are defined, this means that all users and groups can access the application.
