...
See [Troubleshooting access problems](../../troubleshooting/authentication/access-denied.mdx), when set, the user gets a more detailed explanation of access decisions.
