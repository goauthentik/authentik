...
| ----------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------- | ------------------------------------------------------------------------- |
| **Lock password login** :ak-enterprise                                  | Blocks authentication through Password stages. Existing sessions, tokens, and other authentication methods remain available.                                                  | **Locked**                                                  | Click **Unlock password login**, or reset the user's password.            |
