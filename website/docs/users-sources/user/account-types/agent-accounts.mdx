...
For an overview of all account types, see [Account types](./index.mdx). For general information about service accounts, see [Service accounts](./service-accounts.mdx).
...
For more information, see [Manage permissions](../../access-control/manage_permissions.mdx).
...
Agent tokens are managed in the same token system as other authentik tokens. See [Service accounts](./service-accounts.mdx) for general token-management information.
...
Review [Events](../../../sys-mgmt/events/index.mdx) when investigating agent activity or validating that an integration has the expected access.
