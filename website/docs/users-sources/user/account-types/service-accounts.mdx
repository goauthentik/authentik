...
- **Agent accounts**: accounts that act on behalf of a parent user. See [Agent accounts](./agent-accounts.mdx).
...
For more information about assigning permissions, see [Manage permissions](../../access-control/manage_permissions.mdx).
