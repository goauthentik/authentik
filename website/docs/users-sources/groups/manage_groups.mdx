...
To edit the group's name, parent group, whether the group can grant superuser permissions, associated roles, and any custom attributes, click the Edit icon beside the role's name. Make the changes and then click **Update**.
