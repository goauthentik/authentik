...
3. Click **Finish**.
4. On the **Federation and Social login** page, click the name of the newly created SCIM source.
...
If authentik has the required browser permissions, the token will be copied to your clipboard after you click the **Click to copy token** button. However, some browsers do not allow this. In those cases, a notification will appear in the bottom-right corner with the token, and you need to copy it manually.
:::
...
1. Log in to authentik as an administrator and open the authentik Admin interface.
2. Navigate to **Directory** > **Federation and Social login** and click the name of the SCIM source.
