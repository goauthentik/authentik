...
For more information, see the [Google Workspace Integration](/integrations/cloud-providers/google/) guide.
:::
...
[Configure Google Cloud with authentik](./cloud/index.mdx)
...
[Configure Google Workspace with authentik](./workspace/index.mdx)
