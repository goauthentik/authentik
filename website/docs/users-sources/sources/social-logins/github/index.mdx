...
2. Navigate to **Directory** > **Federation and Social login**, click **Create**, and then configure the following settings:
    ...
    - **Create Facebook OAuth Source**: provide a name, set the slug to `github`, and set the following required configurations:
...
6. Click **Finish**. You can now bind this policy to the chosen enrollment and/or authentication flow of the GitHub OAuth source.
