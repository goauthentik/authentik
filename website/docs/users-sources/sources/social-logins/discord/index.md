...
### Syncing Discord roles and avatars to authentik via property mapping
...
### Checking for membership of a Discord Guild via policy
...
### Checking for membership of a Discord Guild role via policy
