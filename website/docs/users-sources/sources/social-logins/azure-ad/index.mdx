...
In authentik, create a new _Azure AD OAuth Source_ in Directory -> Federation and Social login -> Create -> Azure AD OAuth Source.
...
- Consumer secret: `*Value* of the secret from above. NOT the secret ID.`
