...
- Sync keytab: create or select a secret containing the base64-encoded keytab created above.
...
- SPNEGO keytab: create or select a secret containing the base64-encoded keytab created above.
