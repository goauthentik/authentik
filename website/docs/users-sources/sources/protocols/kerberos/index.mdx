...
- With SPNEGO, where users can log in to authentik with their [browser](./browser.mdx) and their Kerberos credentials.
...
- User property mappings and group property mappings: see [Source property mappings](../../property-mappings/index.mdx) and the section below for details.
...
- Sync keytab: create or select a **Multi-line text** secret containing the base64-encoded keytab created above, or upload the keytab as a **File** secret.
...
- SPNEGO keytab: create or select a **Multi-line text** secret containing the base64-encoded keytab created above, or upload the keytab as a **File** secret.
...
You might need to configure your web browser to allow SPNEGO. Check out [our documentation](./browser.mdx) on how to do so. You can now log in to authentik using SPNEGO.
...
See the [overview](../../property-mappings/index.mdx) for information on how property mappings work with external sources.
