...
authentik Enterprise subscriptions over US$1,000 per year include ticket-based support, as listed on the [pricing page](https://goauthentik.io/pricing/). Enterprise Plus subscriptions include the support channels and response-time commitments defined in your agreement.
...
For an air-gapped installation, collect the diagnostics locally and transfer them to a connected system to submit the ticket. The authentik installation does not need internet access to receive support.
...
The [supported versions table](../security/policy.mdx#supported-versions) lists the releases that receive security fixes. Use the latest patch release within a supported version, and check your Enterprise agreement for its support commitments.
