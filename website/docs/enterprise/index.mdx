...
- [Compare Enterprise features](./enterprise-features.mdx) across both plans.
- [Get started with authentik Enterprise](./get-started.mdx) on a new or existing authentik installation.
...
- [Enterprise support](./enterprise-support.mdx) to open and track support tickets.
