...
Before opening a ticket, update to the latest patch release available for your supported release series. The support team might ask you to upgrade if a newer patch release already fixes the reported problem.
