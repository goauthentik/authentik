...
An **internal** user is typically a team member, such as a company employee, who has access to the full Enterprise feature set including the **My Applications** page and self-service functionality.
