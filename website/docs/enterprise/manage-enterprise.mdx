...
- Current active internal and external user totals, including how many active accounts were added within the last 30, 90, and 365 days.
- The latest expiry date and current license status. Without an installed license, the status card displays **Unlicensed**. With an installed license, including an expired license, it also displays user capacity and usage.
