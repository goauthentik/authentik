...
Flow: right-click [here](/blueprints/enrollment-2-stage.akflow) and save the file.
...
Flow: right-click [here](/blueprints/enrollment-email-verification.akflow) and save the file.
...
Flow: right-click [here](/blueprints/login-2fa.akflow) and save the file.
...
Flow: right-click [here](/blueprints/login-conditional-captcha.akflow) and save the file.
...
Flow: right-click [here](/blueprints/recovery-email-verification.akflow) and save the file.
...
Flow: right-click [here](/blueprints/unenrollment.akflow) and save the file.
