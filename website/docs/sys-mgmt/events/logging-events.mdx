...
Event logging in authentik is highly configurable. You can set the [retention period](./index.mdx#event-retention-and-forwarding) for storing and displaying events, specify which events should trigger a [notification](./notifications.mdx), and access low-level details about when and where each event occurred.
...
## View events in maps and charts :ak-enterprise {#viewing-events-in-maps-and-charts}
