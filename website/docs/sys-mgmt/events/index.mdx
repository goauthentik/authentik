...
Events can be used to define [notification rules](notifications.mdx), with specified [transport options](transports.mdx) of either local (shown in the authentik UI), email, or webhook.
