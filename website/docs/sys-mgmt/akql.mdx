...
- **Directory** > **Users**: See [Manage users](../users-sources/user/user_basic_operations.mdx#advanced-queries).
- **Directory** > **Groups**: See [Manage groups](../users-sources/groups/manage_groups.mdx#advanced-queries).
- **Event Matcher policies**: the **Query** field on an [Event Matcher policy](../customize/policies/types/event-matcher.mdx#what-it-matches).
...
| ------------------ | --------- | ------------------------------------------------------------------------------------- |
| `action`           | Choice    | The [event action](./events/event-actions.mdx), such as `login`.                      |
...
| `brand.pk`         | String    | The primary key of the [brand](../customize/branding/index.mdx) active for the event. |
...
Use the **Query** field on an [Event Matcher policy](../customize/policies/types/event-matcher.mdx) to match events with AKQL.
