...
:::info
This feature is available from 2024.2 and is not to be confused with [brands](../customize/branding/index.md), which were previously called tenants.
:::
...
Learn more in [Manage Enterprise licensing](../enterprise/manage-enterprise.mdx#license-management).
