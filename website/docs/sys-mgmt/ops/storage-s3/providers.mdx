...
Configure the shared settings in [S3-compatible storage](./index.mdx), then use the section for your storage service to set its endpoint and authentication options.
