...
- [Upgrade PostgreSQL on Docker Compose](../../troubleshooting/postgres/upgrade_docker.mdx)
- [Upgrading PostgreSQL on Kubernetes](../../troubleshooting/postgres/upgrade_kubernetes.mdx)
