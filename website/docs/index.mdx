...
-   For information about integrating a specific application or software into authentik, refer to our [Integrations](../integrations/index/) section, accessible from the top menu bar.
