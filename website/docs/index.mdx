...
authentik is an IdP (Identity Provider) and SSO (Single Sign On) provider that is built with security at the forefront of every piece of code, every feature, with an emphasis on flexibility and versatility.
