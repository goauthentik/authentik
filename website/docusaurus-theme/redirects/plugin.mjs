 ...
 * @file Docusaurus client-side redirects plugin. Exposes parsed redirect entries as Docusaurus
 *   global data, allowing the client-side router to follow redirects when it hits a missing page
 *   (see `theme/NotFound`).
 */
