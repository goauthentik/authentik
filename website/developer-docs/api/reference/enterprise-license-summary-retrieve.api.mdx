                                    ...
                                    >
                                        ...
                                        <ul style={{ marginLeft: "1rem" }}>
                                            ...
                                            <SchemaItem
                                                ...
                                                required={true}
                                                schemaName={
                                                    "LicenseSummaryStatusEnum (string)"
                                                }
                                                qualifierMessage={
                                                    "**Possible values:** [`unlicensed`, `valid`, `expired`, `expiry_soon`, `limit_exceeded_admin`, `limit_exceeded_user`, `read_only`]"
                                                }
                                                schema={{
                                                    enum: [
                                                        "unlicensed",
                                                    ...
                                                    type: "string",
                                                    title: "LicenseSummaryStatusEnum",
                                                }}
                                            ></SchemaItem>
                                            <SchemaItem
                                                collapsible={false}
                                            ...
                                            <SchemaItem
                                                ...
                                                required={true}
                                                schemaName={
                                                    "LicenseFlagsEnum (string)[]"
                                                }
                                                qualifierMessage={
                                                    "**Possible values:** [`trial`, `non_production`]"
                                                }
                                                schema={{
                                                    type: "array",
                                                    items: {
