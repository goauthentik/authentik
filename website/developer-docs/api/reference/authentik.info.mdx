...
<div style={{ marginBottom: "2rem" }}>
    ...
    <SchemaTabs className={"openapi-tabs__security-schemes"}>
        <TabItem label={"HTTP: Bearer Auth"} value={"authentik"}>
            <div>
                <table>
                    <tbody>
                        <tr>
...
>
    ...
    <span>[hello@goauthentik.io](mailto:hello@goauthentik.io)</span>
</div>
<div style={{ marginBottom: "var(--ifm-paragraph-margin-bottom)" }}>
    <h3 style={{ marginBottom: "0.25rem" }}>License</h3>
    <a href={"https://github.com/goauthentik/authentik/blob/main/LICENSE"}>
        MIT
    </a>
</div>
