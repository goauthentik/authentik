...
-   Use `code` format when referring to:
    ...
    -   file paths
    -   directory names
    -   code snippets (sinlge line or a block of code)

-   For variables or placeholders use *italic* font for the variable, place angle brackets around it, and use place-holder names that makes it obvious that the user needs to replace it.
