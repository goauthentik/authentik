...
-   Use abbreviations where it makes sense (for commonly used terms like SAML or RBAC) for common terms. If an abbreviation is less-known, spell it out in parentheses after the first use.
