...
Use tables, bullet lists, Head 3s... whatever you need to clearly rpesent the values.

Be sure to use a sentence after every heading, to explain what the sectin is about, how the values are used, etc.
