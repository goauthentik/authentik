...
import { generateVersionDropdown } from "./releases/dropdown.mjs";
import {
    SUPPORTED_RELEASE_COUNT,
    collectReleaseFiles,
    createReleaseSidebarEntries,
} from "./releases/utils.mjs";
...
const sidebar = {
    docs: [
        {
            type: "html",
            value: generateVersionDropdown(
                releases.slice(0, SUPPORTED_RELEASE_COUNT).map((release) => release.name),
            ),
        },
        ...sidebarEntries,
