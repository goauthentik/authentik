...
When the company founder is from an Infrastructure background, and the first person he decides to hire is also from Infra, you can imagine that we end up with some pretty strong opinions about tools and processes.
...
All of this is to say that we’re not doing anything fancy here (in keeping with our approach of [optimizing for stability](https://goauthentik.io/blog/2023-12-21-five-lessons-from-choosing-infrastructure-tooling#5-optimize-for-stability-and-support)), but even though these are common paths, there are some pitfalls to watch out for…
