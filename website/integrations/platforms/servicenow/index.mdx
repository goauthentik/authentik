...
> ServiceNow is a cloud platform for building and running workflow-driven applications, mainly for IT, HR and support teams. It provides a data model, automation engine and UI layer so you can log requests, trigger rules (like approvals or escalations) and integrate with other systems, all in one place.
>
...
- `company.servicenow.com` is the FQDN of the ServiceNow instance.
...
To support the integration of ServiceNow with authentik, you need to create an application/provider pair in authentik.
...
Template sentence that you can typically use here: "To confirm that authentik is properly configured with ServiceNow, log out and log back in via authentik."
