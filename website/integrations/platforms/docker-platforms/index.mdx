...
This guide configures authentik as a SAML identity provider for Docker platforms through Docker SSO. Users can access Docker Hub, Docker Desktop, and Docker Sandboxes with the same Docker authentication and organization membership. Docker Sandboxes run AI coding agents in isolated microVMs.
