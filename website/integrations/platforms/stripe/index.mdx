...
Stripe requires a verified email domain before SSO can be enabled. Domain verification is a Stripe-side prerequisite and is outside the scope of this integration guide.
:::
