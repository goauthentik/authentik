...
[External users](https://support.atlassian.com/security-and-access-policies/docs/who-are-external-users/) log in with Atlassian Cloud credentials first, and are then prompted for authentik credentials when they access protected Atlassian Cloud apps.
:::
