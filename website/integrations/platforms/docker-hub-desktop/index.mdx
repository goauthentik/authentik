---
title: Integrate with Docker Hub and Docker Desktop
sidebar_label: Docker Hub and Docker Desktop
support_level: community
---

import SAMLProvider20265Warning from "../../_saml-provider-2026-5-warning.mdx";

## What are Docker Hub and Docker Desktop?

> Docker Hub is a service for storing and sharing container images. Docker Desktop is an application for building and running containers locally.
>
> -- https://www.docker.com/

This guide configures authentik as a SAML identity provider for Docker Hub and Docker Desktop.
...
To support the integration of Docker Hub and Docker Desktop with authentik, create an application/provider pair in authentik.
...
2. Navigate to **Applications** > **Applications** and click **New Application** to open the application wizard.
    ...
    - **Configure Bindings** _(optional)_: create a [binding](/docs/add-secure-apps/bindings-overview/) (policy, group, or user) to manage which users can access Docker Hub and Docker Desktop from their **Application Dashboard** page.
...
## Docker Hub and Docker Desktop configuration
...
To confirm that authentik is properly configured with Docker Hub and Docker Desktop, open the integration from the authentik Application Dashboard and sign in with an email address from the verified domain. You should be redirected to authentik and then returned to Docker Hub.
