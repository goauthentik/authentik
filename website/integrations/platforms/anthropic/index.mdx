...
1. Enable **group mappings** before saving the JIT provisioning configuration.
2. Map the IdP group values from the SAML `groups` attribute to the appropriate Anthropic roles and seat types.
