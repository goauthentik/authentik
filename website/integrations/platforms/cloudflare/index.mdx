...
- A working Cloudflare Access identity provider that uses authentik. If this is not already configured, follow the [Cloudflare Access integration guide](../../security/cloudflare-access/index.mdx) first.

This guide configures SSO for the Cloudflare Dashboard. To protect applications with Cloudflare Access, use the [Cloudflare Access integration guide](../../security/cloudflare-access/index.mdx) instead.
