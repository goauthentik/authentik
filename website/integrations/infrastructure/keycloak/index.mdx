...
To ensure that authentik is correctly integrated with Keycloak, log out and then log back in by clicking **SAML** or **OIDC**. You should be redirected to authentik to log in, and if the process is successful, you'll be taken to the Keycloak dashboard.
