...
3. Copy the **Certificate Fingerprint (SHA256)** of the certificate.
4. Save this value for when you configure Zendesk.
...
To confirm that authentik is properly configured with Zendesk, log out, then attempt to log back in by visit your Zendesk page and clicking **Login with authentik**.
