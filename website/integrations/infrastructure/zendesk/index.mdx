...
3. Click **Submit** to save the new application and provider.
4. Go to **System** > **Certificates** > and copy the **SHA-256 Fingerprint** of the certificate you selected when you configured the provider. We will need to give it to Zendesk in the next steps.
