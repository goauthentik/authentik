...
- **Configure the Provider**: provide a name (or accept the auto-provided name), the authorization flow to use for this provider, and the following required configurations.
    ...
    - Add a **Redirect URI** of type `Strict` `Post Logout` as `https://guacamole.company/`. If you have configured [Apache Tomcat](https://tomcat.apache.org/) to run Apache Guacamole on a subpath, you will need to update this value accordingly.
...
You must also add one of the following variables, depending on your desired behavior:
...
You must also add one of the following settings depending on your desired behavior:
