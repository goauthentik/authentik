...
> Nutanix Prism Central, also known as Nutanix PC, is a centralized software virtual appliance used to manage multiple Nutanix and non-Nutanix clusters from a single interface. It supports single sign-on with SAML 2.0 identity providers.
>
