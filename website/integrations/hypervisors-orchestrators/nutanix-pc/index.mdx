...
:::warning Prism Central Signing Certificates
Prism Central does not support full chain Signing Certificates. Ensure that the selected certificate only contains one certificate.
:::
