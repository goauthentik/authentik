...
:::info Helm secrets
For security reasons, do not inline the client secret in Helm values. Reference the secret from `grafana.ini` instead. For more information, see [How to securely reference secrets in grafana.ini](https://github.com/grafana-community/helm-charts/blob/main/charts/grafana/README.md#how-to-securely-reference-secrets-in-grafanaini)
:::
