...
- [OpenObserve documentation - Enable RBAC](https://openobserve.ai/docs/user-guide/account-administration/identity-and-access-management/enable-rbac-in-openobserve-enterprise/)
