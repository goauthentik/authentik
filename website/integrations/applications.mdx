...
To add documentation for a new application (with support level Community or Vendor), please use the integration template [`service.md`](https://github.com/goauthentik/authentik/blob/main/website/topics/integrations/template/service.md) file from our GitHub repo. You can download the template file using the following command:
