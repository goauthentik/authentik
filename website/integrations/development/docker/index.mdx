...
> Docker provides tools and services for building, sharing, and running containerized applications.
>
...
To support the integration of Docker with authentik, create an application/provider pair in authentik.
...
2. Navigate to **Applications** > **Applications** and click **New Application** to open the application wizard.
    ...
    - **Configure Bindings** _(optional)_: create a [binding](/docs/add-secure-apps/bindings-overview/) (policy, group, or user) to manage which users can access Docker from their **Application Dashboard** page.
...
To confirm that authentik is properly configured with Docker, open Docker from the authentik Application Dashboard and sign in with an email address from the verified domain. You should be redirected to authentik and then returned to Docker Hub.
