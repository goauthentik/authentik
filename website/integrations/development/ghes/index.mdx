...
> GitHub Enterprise Server is a self-hosted software development platform. It provides Git repository hosting, collaboration tools, and enterprise identity and access management.
>
