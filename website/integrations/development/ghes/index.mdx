...
2. Navigate to **Applications** > **Applications** and click **New Application** to create an application and provider pair. (Alternatively you can first create a provider separately, then create the application and connect it with the provider.)
    ...
    - **Configure the Provider**: provide a name, select an authorization flow, and configure the following settings:
        ...
        - Under **Advanced protocol settings**:
            ...
            - Set **Property mappings** to `authentik default SAML Mapping: Username`, `authentik default SAML Mapping: Email`, and `authentik default SAML Mapping: Name`.
...
3. Configure the following settings:
    ...
    - Under **User attributes**, configure the following SAML attribute names:
        ...
        - **Emails**: `http://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress`
...
- [GitHub Enterprise Server: SAML configuration reference](https://docs.github.com/en/enterprise-server@latest/admin/managing-iam/iam-configuration-reference/saml-configuration-reference#saml-attributes)
