...
If you require [Nextcloud server-side encryption](https://docs.nextcloud.com/server/latest/admin_manual/configuration_files/encryption_configuration.html) with per-user keys, use LDAP. OIDC and SAML do not provide Nextcloud with the user's cleartext password, which can prevent encrypted user data from being decrypted.
:::
...
### Enable OIDC back-channel logout _(optional)_
...
### Make OIDC the default login method _(optional)_
