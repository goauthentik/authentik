    ...
    - **Create Scope Mapping**:
        ...
        - **Expression**:
            ...
            return {
                ...
                "user_id": user.attributes.get("nextcloud_user_id", user.username.lower()),
            }
            ```
...
:::info
To connect to an existing Nextcloud user, set the `nextcloud_user_id` attribute to match the Nextcloud user ID. If the authentik username already matches the Nextcloud user ID, you can use `user.username.lower()`.
:::
