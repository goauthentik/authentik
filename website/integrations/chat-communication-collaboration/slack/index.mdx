...
Users that should be provisioned to Slack will then need to be bound to the Slack application. For more information on user and group filtering, refer to the [SCIM provider documentation](../../../providers/scim/#filter-the-sync-scope) .
