...
:::warning
If you access Seerr over HTTPS through a reverse proxy, enable proxy support in **Settings** > **Network**. Otherwise, Seerr can send an HTTP redirect URI to authentik.
:::
