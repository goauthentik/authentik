...
To confirm that authentik is properly configured with Ironclad, log out of Ironclad and open the integration. You should be redirected to authentik to log in, and if successful, you should then be redirected to the Ironclad dashboard.
