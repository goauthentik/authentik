...
To confirm that authentik is correctly integrated with Wallos, log out, open Wallos, and click **Log in with authentik**. You should be redirected to authentik, and after successful authentication, returned to Wallos.
