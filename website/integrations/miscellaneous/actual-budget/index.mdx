...
> Actual Budget is a fast, privacy-focused app for managing personal finances. At its heart is the well proven and much loved Envelope Budgeting methodology.
>
...
{
    "openId": {
        "discoveryURL": "https://authentik.company/application/o/<application_slug>/",
...
7. Click **OK**. Actual Budget redirects you to the login page after saving the OpenID configuration.
...
- [Actual Budget docs - Managing Multi-User Support](https://actualbudget.org/docs/config/multi-user/)
