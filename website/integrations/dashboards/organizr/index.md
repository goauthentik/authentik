...
:::
:::tip
Consider front-ending your application with a [forward auth provider](https://docs.goauthentik.io/add-secure-apps/providers/proxy/forward_auth) for an SSO experience.
:::
