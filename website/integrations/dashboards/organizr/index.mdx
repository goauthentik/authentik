...
- [Organizr LDAP backend documentation](https://docs.organizr.app/features/authentication-backends/ldap-backend)
- [Organizr OIDC support discussion](https://github.com/causefx/Organizr/issues/2070#issuecomment-4957190082)
