...
2. Navigate to **Applications** > **Applications** and click **New Application** to open the application wizard.
    ...
    - **Configure the Provider**: provide a name (or accept the auto-provided name), the authorization flow to use for this provider, and the following required configurations.
        ...
        - Set a `Strict` `Authorization` **redirect URI** to `https://127.0.0.1/xcreds`.
...
After XCreds is installed on a target Mac, configure it by creating, installing, and applying a configuration profile. For more information, refer to the [XCreds Admin Guide](https://twocanoes.com/knowledge-base/xcreds-admin-guide/).
