...
Add the following environment variables to your Mealie configuration. Make sure to fill in the Client ID and Client Secret from your authentik instance.
