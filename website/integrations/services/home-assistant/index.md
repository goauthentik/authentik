...
openid:
    client_id: <Client ID from authentik step 2>
    client_secret: <Client Secret from authentik step 2>
    configure_url: "https://authentik.company/application/o/<Slug from authentik step 2>/.well-known/openid-configuration"
...
Make sure the user account has been created in Home Assistant, since this integration does not create the users for you.
