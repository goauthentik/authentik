...
-   Signing Key: Set the key as `authentik.company`
...
## Guacamole User Creation

In Guacamole - if everything has configured correctly you will see in the bottom left corner `Sign in with: OpenID`
Before you are able to use this - using your preconfigured Admin Account - Login then create a User using your Email Address (one set in Authentik) as the username. Give the persmission as you prefer. When you then login you will now see as configured.
