...
4. Click on the name of the newly created group and navigate to the **Users** tab.
...
authc:
    ...
    saml_auth_domain:
        ...
        http_authenticator:
            ...
            config:
                idp:
                    metadata_file: "/etc/wazuh-indexer/opensearch-security/<em>wazuh_authentik_meta.xml</em>"
                    entity_id: "wazuh-saml"
                sp:
                    entity_id: "wazuh-saml"
                kibana_url: "https://<em>wazuh-dashboard.company/</em>"
                roles_key: Roles
...
<kbd>export JAVA_HOME=/usr/share/wazuh-indexer/jdk/ && bash /usr/share/wazuh-indexer/plugins/opensearch-security/tools/securityadmin.sh -f /etc/wazuh-indexer/opensearch-security/config.yml -icl -key /etc/wazuh-indexer/certs/admin-key.pem -cert /etc/wazuh-indexer/certs/admin.pem -cacert /etc/wazuh-indexer/certs/root-ca.pem -h <em>wazuh-indexer.company</em> -nhnv</kbd>
...
<kbd>export JAVA_HOME=/usr/share/wazuh-indexer/jdk/ && bash /usr/share/wazuh-indexer/plugins/opensearch-security/tools/securityadmin.sh -f /etc/wazuh-indexer/opensearch-security/roles_mapping.yml -icl -key /etc/wazuh-indexer/certs/admin-key.pem -cert /etc/wazuh-indexer/certs/admin.pem -cacert /etc/wazuh-indexer/certs/root-ca.pem -h <em>wazuh-indexer.company</em> -nhnv </kbd>
