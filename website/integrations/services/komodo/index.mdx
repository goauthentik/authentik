...
4. Log in to Komodo as an administrator.
5. Navigate to **Settings**, and under the **Users** section, click the name of your authentik user. The **User type** should be **OIDC**.
