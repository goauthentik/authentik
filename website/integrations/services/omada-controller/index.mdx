...
1. Go to https://www.base64encode.org/ or another Base64 encoding service/application.
2. In the **Encode to Base64 format** section, enter: `<Resource ID>_<Omada ID>`.
3. Click **Encode**.
