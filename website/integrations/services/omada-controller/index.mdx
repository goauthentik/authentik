...
To support the integration of Omada Controller with authentik, you need to create an application/provider pair in authentik.
...
9. Set the desired **SAML Role Name**, **Role**, and **Privileges** for the new SAML role. Click TEMP
...
4. Under **Advanced protocol settings**, set **Default relay state** to the decoded value from the previous section. TEMP
5. Click **Update**
