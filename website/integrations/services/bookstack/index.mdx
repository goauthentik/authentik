...
Once that's done, the next step is to update your `.env` file to include the following variables:
    ...
    OIDC_ISSUER=https://authentik.company/application/o/<application-slug>
...
3. Under **Related objects** > **Metadata**, click on **Copy download URL**. This is your authentik metadata download URL and it will be required in the next section.
