...
From the **Admin interface**, navigate to **Applications** > **Providers** and click on the provider tied to the application/provider pair created in the previous step.

Under the **Related objects** section, click **Copy download URL**. Take note of this value as you will need it later.
