...
2. Click the "Admin interface".

### Step 2: Create a New Authentication Provider
3. Under "Applications", click "Providers" and create a new provider.
4. Choose "OAuth2/OpenID Provider" and click "Next".
...
8. Ensure the signing key is set to "Authentik Self-signed Certificate".
...
12. Ensure the "Policy engine mode" is set to "ANY, any policy must match to grant access".
13. Click "Create" and navigate to your [Cloudflare Access dashboard](https://one.dash.cloudflare.com).
