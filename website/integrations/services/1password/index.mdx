...
5. Take note of the **Redirect URIs** that are shown shown because they will be required in the next section.
6. Keep the page open as you will need to return to it after reconfiguring authentik.
