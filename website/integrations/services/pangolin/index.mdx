...
Template sentence that you can typically use here: "To confirm that authentik is properly configured with Pangolin, log out and log back in via authentik."
