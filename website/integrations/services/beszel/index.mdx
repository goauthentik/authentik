...
- **Configure Bindings** _(optional):_ you can create a [binding](https://docs.goauthentik.iohttps://docs.goauthentik.io/docs/add-secure-apps/flows-stages/bindings/) (policy, group, or user) to manage the listing and access to applications on a user’s \***\*My applications** \*_page_.\*
