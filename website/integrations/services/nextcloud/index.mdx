...
1. In Nextcloud, ensure the **OpenID Connect user backend** app is installed.
...
1. In Nextcloud, ensure the **SSO & SAML Authentication** app is installed.
2. Navigate to **Settings** > **SSO & SAML Authentication** and configure the following settings:
...
1.  **Install the app**:
    In Nextcloud, ensure the **LDAP user and group backend** app is installed. Then navigate to **Settings** > **LDAP user and group backend**.
...
- On the **Server** tab:
    ...
    - Click the **+** icon and enter the following settings:
        - **Host**: enter the hostname/IP address of the authentik LDAP outpost preceeded by `ldap://`
        - **Port**: `389`
