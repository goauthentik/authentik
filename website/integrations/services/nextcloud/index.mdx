...
To confirm that authentik is properly configured with Nextcloud, log out and log back in using the **OpenID Connect** option. You will be redirected to authentik to log in, if successful you will then be redirected to the Nextcloud dashboard.
