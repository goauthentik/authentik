...
# Stage 1: Build
FROM --platform=${BUILDPLATFORM} docker.io/library/golang:1.27rc3-trixie@sha256:cfe86233ee62fdd21829829d9a11a0a84db261e5c08ef179503605b7a925ddd2 AS builder
