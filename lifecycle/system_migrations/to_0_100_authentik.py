...
ALTER TABLE passbook_core_user_ak_groups RENAME TO authentik_core_user_ak_groups;
...
ALTER SEQUENCE passbook_core_user_ak_groups_id_seq RENAME TO authentik_core_user_ak_groups_id_seq;
