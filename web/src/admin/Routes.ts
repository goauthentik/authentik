...
export const ROUTES: Route[] = [
    ...
    new Route(new RegExp("^/endpoints/tags$"), async () => {
        await import("#admin/endpoints/DeviceTagListPage");
        return html`<ak-endpoints-device-tag-list></ak-endpoints-device-tag-list>`;
    }),
