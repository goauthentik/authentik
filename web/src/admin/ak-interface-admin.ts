...
import { formatInterfacePrefix, toAdminInterface, toUserInterface } from "#elements/router/core/interfaces";
        ...
        const commands: PaletteCommandDefinitionInit[] = [
            {
                ...
                action: () =>
                    navigate(toAdminInterface("core/applications", { "create-wizard": "application" })),
                            ...
                            <div class="pf-c-drawer__content">
                                <div class="pf-c-drawer__body">
                                    <ak-router-view
                                        ...
                                        id="main-content"
                                        .routes=${ROUTES}
                                        .prefix=${formatInterfacePrefix(globalAK().api.relBase, "admin")}
