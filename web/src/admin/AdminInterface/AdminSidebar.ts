...
import { WithVersionConfig } from "@goauthentik/elements/Interface/versionProvider";
...
export class AkAdminSidebar extends WithVersionConfig(WithCapabilitiesConfig(AKElement)) {
    ...
    renderNewVersionMessage() {
        return this.version?.versionCurrent && this.version?.versionCurrent !== VERSION
            ? html`
