...
import { BskySource, ModelEnum, SourcesApi } from "@goauthentik/api";
...
@customElement("ak-source-bsky-view")
export class BskySourceViewPage extends AKElement {
        ...
        return html`<main>
                        ...
                        <div class="pf-c-card pf-l-grid__item pf-m-12-col">
                            ...
                            <div class="pf-c-card__footer">
                                <ak-forms-modal>
                                    ...
                                    <span slot="header">${msg("Update Bluesky Source")}</span>
                                    <ak-source-bsky-form
                                        slot="form"
                    ...
                    <div class="pf-l-grid pf-m-gutter">
                        <div class="pf-c-card pf-l-grid__item pf-m-12-col">
                            <ak-object-changelog
                                ...
                                targetModelName=${ModelEnum.AuthentikSourcesBskyBskysource}
                            >
                            </ak-object-changelog>
                        </div>
                    </div>
            ...
            You can only use policies here as access is checked before the user is authenticated.`,
                ...
                <ak-rbac-object-permission-page
                    ...
                    model=${ModelEnum.AuthentikSourcesBskyBskysource}
...
declare global {
    interface HTMLElementTagNameMap {
        "ak-source-bsky-view": BskySourceViewPage;
    }
}
