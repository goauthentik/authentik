...
export class AgentConnectorSetup extends AKElement {
    ...
    render() {
        ...
        <ul class="pf-c-list pf-m-inline">
            <li><a href="https://pkg.goauthentik.io/packages/authentik_windows-2025_agent/agent_local/agent.msi">${msg("Windows")}</a></li>
            <li><a href="https://pkg.goauthentik.io/packages/authentik_macos-15_agent/agent_local/authentik%20agent%20installer.pkg">${msg("macOS")}</a></li>
