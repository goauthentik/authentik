...
export class ReputationPolicyForm extends ModelForm<ReputationPolicy, string> {
    ...
    renderForm(): TemplateResult {
        return html`<form class="pf-c-form pf-m-horizontal">
            ...
            <div class="form-help-text">
                ${msg(`Invalid login attempts will decrease the score for the client's IP, and the
                username they are attempting to login as, by one.`)}
            </div>
            <div class="form-help-text">
                ${msg(`The policy passes when the reputation score is below the threshold, and
                ...
                <div slot="body" class="pf-c-form">
                    <ak-form-element-horizontal name="checkIp">
                        <div class="pf-c-check">
                            ...
                            />
                            <label class="pf-c-check__label"> ${msg("Check IP")} </label>
                        </div>
                    </ak-form-element-horizontal>
                    <ak-form-element-horizontal name="checkUsername">
                        <div class="pf-c-check">
                            ...
                            />
                            <label class="pf-c-check__label"> ${msg("Check Username")} </label>
                        </div>
                    </ak-form-element-horizontal>
                    <ak-form-element-horizontal
                        label=${msg("Threshold")}
