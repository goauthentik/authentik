import "@goauthentik/admin/common/ak-certificate-search/ak-multi-certificate-search";
...
${this.instance?.redirectUris}</textarea
                    ...
                    <ak-form-element-horizontal label=${msg("Signing Key")} name="signingKey">
                        <ak-multi-certificate-search
                            current-certificate=${this.instance?.signingKey}
                            has-key
                        ></ak-multi-certificate-search>
