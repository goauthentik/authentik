    ...
    render(): TemplateResult {
        ...
        switch (this.event?.action) {
            ...
            case EventActions.UpdateAvailable:
                return html`<h3>${msg("New version available!")}</h3>
                    <a
                        target="_blank"
