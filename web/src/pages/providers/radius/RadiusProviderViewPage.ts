...
import { ProvidersApi, RadiusProvider } from "authentik-api";
...
export class RadiusProviderViewPage extends LitElement {
    ...
    set providerID(value: number) {
        new ProvidersApi(DEFAULT_CONFIG).providersRadiusRetrieve({
            id: value,
                            ...
                            <div class="pf-c-card">
                                <div class="pf-c-card__body">
                                    <dl class="pf-c-description-list pf-m-3-col-on-lg">
                                        ...
                                        <div class="pf-c-description-list__group">
                                            <dt class="pf-c-description-list__term">
                                                <span class="pf-c-description-list__text">${t`Client Networks`}</span>
                                            </dt>
                                            <dd class="pf-c-description-list__description">
                                                <div class="pf-c-description-list__text">${this.provider.clientNetworks}</div>
                                            </dd>
                                        </div>
                                    </dl>
                                </div>
