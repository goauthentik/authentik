 ...
 *
 * This is particularly useful when a property binding is used, and you want to avoid triggering
 * updates on initial assignment.
 */
...
/**
 * A default property declaration for properties that are only bound, and should not reflect to
 * attributes or have other special behavior.
 */
