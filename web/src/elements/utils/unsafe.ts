...
/**
 * Type predicate to determine if a given {@linkcode CustomElementConstructor} extends
 * {@linkcode AKElement}.
 */
...
/**
 * Given a Lit property declaration, a resolved prefix, and the original property key, determine the
 * appropriate name to use for rendering the property, taking into account any custom attribute name
...
/**
 * Given a pre-registered custom element tag name and a record of properties, render the element
 * with the given properties applied.
 *
