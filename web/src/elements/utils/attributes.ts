...
/**
 * A variant of {@linkcode ifDefined} which allows for truthy values to apply an attribute value.
 */
...
/**
 * Given a list of parts and an optional prefix, returns a string suitable for use in an
