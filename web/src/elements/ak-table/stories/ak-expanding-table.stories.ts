...
import "../ak-expanding-table.js";
import { ExpandingTable } from "../ak-expanding-table.js";
import { KeyBy } from "../types";
import type { TableRow } from "../types";
import { convertContent } from "../utils.js";
import { nutritionDbUSDA } from "./sample_nutrition_db.js";

const metadata: Meta<ExpandingTable> = {
    title: "Elements / Table /ExpandingTable",
    component: "ak-expanding-table",
    parameters: {
        docs: {
            description: {
                component: "Our basic table, now with expansions",
            },
        },
    },
    argTypes: {
...
export const Default: Story = {
    render: () =>
        container(
            html`<ak-expanding-table .columns=${columns} .content=${content}></ak-expanding-table>`,
        ),
};
