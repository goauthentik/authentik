...
/**
 * @function convertForTable Takes a variety of input types and streamlines them. Can't handle every
 *   contingency; be prepared to do conversions yourself as resources demand. Great for about 80% of
 *   use cases, though.
 *
 ...
 *     value returned. For content that has already been grouped or converted into a single "flat"
 *     group, providing these functions will not do anything except generate a warning on the
 *     console.
 */
