...
/**
 * A utility function that takes a {@linkcode ModalTemplate} and returns a function that renders the
 * corresponding modal dialog when invoked.
 *
...
/**
 * A utility function that takes a {@linkcode CustomElementConstructor} and returns a function that
 * renders the corresponding modal dialog when invoked.
 *
 ...
 *
 * @param factory The input to render as a modal dialog, either a custom element constructor or a
 *   function that returns a template result.
 * @param init Initialization options for the modal dialog.
 */
export function asInvoker(
