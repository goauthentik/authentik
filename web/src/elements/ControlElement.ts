...
/**
 * @deprecated At some point, in the near future, migrate all form controls to
 *   `FormAssociatedElement`
 * @class - Prototype for all of our hand-made input elements Ensures that the `data-ak-control` property
...
/**
 * Type predicate to determine if an element is a control element, i.e. has the `data-ak-control`
 * attribute or is an instance of `AKControlElement`.
 *
 * @deprecated Use `isFormField` instead, and ensure that your form-associated element implements
 *   `FormField`.
 */
