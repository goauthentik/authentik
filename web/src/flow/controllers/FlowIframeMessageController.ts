 ...
 * @remarks
 *
 * Third-party assistants in the authentication process, notably CAPTCHAs, are loaded in iframes.
 * This controller listens for iframe boundary-crossing events and, if appropriate, forwards them to
 * the FlowExecutor.
 *
 */
