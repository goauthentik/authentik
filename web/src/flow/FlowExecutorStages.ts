...
/**
 * A tuple (with variants) representing the metadata for a stage entry in the stage mapping registry.
 */
// prettier-ignore
...
//
// prettier-ignore
export const StageModules: readonly StageEntry[] = Object.freeze([
