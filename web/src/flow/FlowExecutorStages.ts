 ...
 *     function, following the examples already provided. Variants and Tags have a single strong
 *     differentiator: Tags refer to web components and so must always have a dash, whereas variants
 *     are from a limited supply of names and do not have a dash. The StageFactory will not get
 *     confused. If you get confused, the type-checker will explain it. The resolution of the web
 *     component tag name is: tag supplied, tag received with import, tag derived from component
 *     name. THIS CAN FAIL: a preloaded stage with an incongruent and non- or incorrectly-specified
 *     tag will result in a stage that cannot be rendered. Pre-loaded stages must be tested
 *     carefully.
 */
// ,---.    |    |    ,   .              ,---.|                            |   |
// |---|,---|,---|    |\  |,---.. . .    `---.|--- ,---.,---.,---.,---.    |---|,---.,---.,---.
