...
import { removeStoredUser } from "#components/ak-user-switcher-storage";
    ...
    protected refresh = async () => {
        ...
        return this.#api
            ...
            .then((challenge) => {
                ...
                if (this.challenge.flowInfo?.userSwitchStaleUser) {
                    removeStoredUser(this.challenge.flowInfo.userSwitchStaleUser);
                }
