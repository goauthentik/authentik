...
/**
 * Utility to remove a key from an object, returning a new object. This is used to remove error keys
...
/**
 * Given an object and a list of keys, trim the string values of those keys in the object and return
 * a new object with the trimmed values. Non-string values are returned as-is.
 *
...
/**
 * Try to parse a JSON string, returning a fallback value if parsing fails or if the input is not a
 * string.
 *
 * @param input The input to parse.
 * @param fallback The fallback value to return if parsing fails or if the input is not a string.
 *   Defaults to `null`.
 *
 * @returns The parsed value, or the fallback value if parsing fails or if the input is not a
 *   string.
 */
