import { DEFAULT_CONFIG } from "@goauthentik/web/common/api/config.js";
import { EVENT_LOCALE_REQUEST } from "@goauthentik/web/common/constants.js";
import { isResponseErrorLike } from "@goauthentik/web/common/errors/network.js";
