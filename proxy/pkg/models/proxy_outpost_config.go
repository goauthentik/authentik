...
// ProxyOutpostConfig proxy outpost config
//
// swagger:model ProxyOutpostConfig
type ProxyOutpostConfig struct {
	...
	// oidc configuration
	OidcConfiguration *OpenIDConnectConfiguration `json:"oidc_configuration,omitempty"`
...
// Validate validates this proxy outpost config
func (m *ProxyOutpostConfig) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ProxyOutpostConfig) validateCertificate(formats strfmt.Registry) error {
...
func (m *ProxyOutpostConfig) validateClientID(formats strfmt.Registry) error {
...
func (m *ProxyOutpostConfig) validateClientSecret(formats strfmt.Registry) error {
...
func (m *ProxyOutpostConfig) validateCookieSecret(formats strfmt.Registry) error {
...
func (m *ProxyOutpostConfig) validateExternalHost(formats strfmt.Registry) error {
...
func (m *ProxyOutpostConfig) validateInternalHost(formats strfmt.Registry) error {
...
func (m *ProxyOutpostConfig) validateName(formats strfmt.Registry) error {
...
func (m *ProxyOutpostConfig) validateOidcConfiguration(formats strfmt.Registry) error {
...
func (m *ProxyOutpostConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ProxyOutpostConfig) UnmarshalBinary(b []byte) error {
	var res ProxyOutpostConfig
