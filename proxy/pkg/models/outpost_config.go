...
// OutpostConfig outpost config
//
// swagger:model OutpostConfig
...
// Validate validates this outpost config
func (m *OutpostConfig) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OutpostConfig) validateCertificate(formats strfmt.Registry) error {
...
func (m *OutpostConfig) validateClientID(formats strfmt.Registry) error {
...
func (m *OutpostConfig) validateClientSecret(formats strfmt.Registry) error {
...
func (m *OutpostConfig) validateCookieSecret(formats strfmt.Registry) error {
...
func (m *OutpostConfig) validateExternalHost(formats strfmt.Registry) error {
...
func (m *OutpostConfig) validateInternalHost(formats strfmt.Registry) error {
...
func (m *OutpostConfig) validateName(formats strfmt.Registry) error {
...
func (m *OutpostConfig) validateOidcConfiguration(formats strfmt.Registry) error {
...
func (m *OutpostConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OutpostConfig) UnmarshalBinary(b []byte) error {
	var res OutpostConfig
