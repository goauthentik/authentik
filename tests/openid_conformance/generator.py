...
from tests.e2e.utils import SeleniumTestCase, get_local_ip, retry
from tests.openid_conformance.conformance import Conformance


class BaseOpenIDConformance(SeleniumTestCase):
...
def generate(plan_name: str):
    ...
    conformance = Conformance(f"https://{get_local_ip()}:8443/", None, verify_ssl=False)
