...
class WeChatOAuthRedirect(OAuthRedirect):
    ...
    def get_additional_parameters(self, source: OAuthSource):  # pragma: no cover
        # WeChat (Weixin) for Websites official documentation requires 'snsapi_login' as the *only* scope
        # for the QR code-based login flow.
        # Ref: https://developers.weixin.qq.com/doc/oplatform/Website_App/WeChat_Login/Wechat_Login.html (Step 1)
        return {
            "scope": "snsapi_login",
        }
...
class WeChatOAuth2Client(OAuth2Client):
    ...
    def get_access_token(self, redirect_uri: str, code: str) -> dict[str, Any]:
        ...
        Ref: https://developers.weixin.qq.com/doc/oplatform/Website_App/WeChat_Login/Wechat_Login.html (Step 2)
        """
    ...
    def get_profile_info(self, token: dict[str, Any]) -> dict[str, Any]:
        ...
        Ref: https://developers.weixin.qq.com/doc/oplatform/Website_App/WeChat_Login/Authorized_Interface_Calling_UnionID.html
        """
