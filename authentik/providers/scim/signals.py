...
def post_save_scim(sender: type[Model], instance: User | Group, created: bool, **_):
    """Post save handler"""
    scim_signal_direct.delay(class_to_path(instance.__class__), instance.pk, PatchOp.add)
...
def pre_delete_scim(sender: type[Model], instance: User | Group, **_):
    """Pre-delete handler"""
    scim_signal_direct.delay(class_to_path(instance.__class__), instance.pk, PatchOp.remove)
