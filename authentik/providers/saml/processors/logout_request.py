...
class LogoutRequestProcessor:
    ...
    def get_redirect_url(self) -> str:
        ...
        if self.provider.signing_kp and self.provider.sign_logout_request:
            ...
            sig_alg = self._get_signature_algorithm_url()
            ...
            LOGGER.info(
                "Signed logout request for redirect binding",
    ...
    def _get_signature_algorithm_url(self) -> str:
        """Get the signature algorithm URL for redirect binding"""
        # The provider.signature_algorithm already contains the full URL
