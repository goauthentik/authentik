...
class MicrosoftEntraGroupTests(TestCase):
    ...
    def test_group_create_update(self):
        ...
        http.add_response(
            f"https://admin.microsoftapis.com/admin/directory/v1/groups/{ext_id}?key={self.api_key}&alt=json",
            method="PUT",
            body={"id": ext_id},
        )
        with patch(
    ...
    def test_group_create_delete(self):
        ...
        http.add_response(
            f"https://admin.microsoftapis.com/admin/directory/v1/groups/{ext_id}?key={self.api_key}",
            method="DELETE",
        )
        with patch(
            "authentik.enterprise.providers.microsoft_entra.models.MicrosoftEntraProvider.microsoft_credentials",
    ...
    def test_group_create_delete_do_nothing(self):
        ...
        self.provider.group_delete_action = MicrosoftEntraDeleteAction.DO_NOTHING
        self.provider.save()
        uid = generate_id()
        http = MockHTTP()
        http.add_response(
    ...
    def test_sync_task(self):
        ...
        http.add_response(
            f"https://admin.microsoftapis.com/admin/directory/v1/groups/{uid}?key={self.api_key}&alt=json",
            method="PUT",
            body={"id": uid},
        )
