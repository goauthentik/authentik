...
from authentik.enterprise.lifecycle.review.utils import link_for_model, start_of_day
...
class LifecycleRule(SerializerModel):
    ...
    def serializer(self) -> type[BaseSerializer]:
        from authentik.enterprise.lifecycle.review.api.rules import LifecycleRuleSerializer
...
class LifecycleIteration(SerializerModel, ManagedModel):
    ...
    @property
    def serializer(self) -> type[BaseSerializer]:
        from authentik.enterprise.lifecycle.review.api.iterations import (
            LifecycleIterationSerializer,
        )
