# Generated by Django 5.2.10 on 2026-02-03 16:20
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "review",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="authentik_lifecycle.review"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(fields=["content_type"], name="authentik_l_content_4e3a6a_idx")
                ],
        ...
        migrations.AddIndex(
            model_name="review",
            index=models.Index(
                fields=["content_type", "opened_on"], name="authentik_l_content_9d34d5_idx"
            ),
        ),
    ]
