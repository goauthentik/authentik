...
LATEST_MIGRATIONS = [
    ...
    ("authentik_providers_oauth2", "0039_merge_20260923_2031"),
    ("authentik_providers_proxy", "0017_proxyprovider_cookie_secret_ref"),
    ("authentik_providers_radius", "0006_radiusprovider_secret"),
    ("authentik_providers_scim", "0024_scimprovider_auth_basic_password_ref"),
    ...
    def test_upgrade_and_downgrade(self, _send_outpost_update):
        ...
        consumers = [
            ...
            (
                ...
                "SCIMProvider",
                {"token": "token_ref", "auth_basic_password": "auth_basic_password_ref"},
            ),
