...
class TestAPIAuth(TestCase):
    ...
    def test_bearer_valid(self):
        ...
        self.assertEqual(
            TokenAuthentication.bearer_auth(f"Bearer {token.key}".encode()), token.user
        )
    ...
    def test_managed_outpost_success(self):
        """Test managed outpost"""
        user: User = TokenAuthentication.bearer_auth(f"Bearer {settings.SECRET_KEY}".encode())
    ...
    def test_jwt_valid(self):
        ...
        self.assertEqual(
            TokenAuthentication.bearer_auth(f"Bearer {refresh.token}".encode()), refresh.user
        )
