...
from passbook.channels.out_saml.utils import get_random_id
from passbook.channels.out_saml.utils.encoding import decode_base64_and_inflate, nice64
from passbook.channels.out_saml.utils.time import get_time_string, timedelta_from_string
from passbook.channels.out_saml.utils.xml_render import (
    get_assertion_xml,
    get_response_xml,
)
...
class Processor:
    ...
    Sub-classes should provide Service Outlet-specific functionality."""
    ...
    def __init__(self, remote: "SAMLOutlet"):
    ...
    def _format_assertion(self):
        ...
        attributes = []
        from passbook.channels.out_saml.models import SAMLPropertyMapping
    ...
    def _decode_and_parse_request(self):
        ...
        params["PROVIDER_NAME"] = root.attrib.get("OutletName", "")
    ...
    def _validate_request(self):
        ...
        if self._remote.acs_url != request_acs_url:
            msg = (
                f"ACS URL of {request_acs_url} doesn't match Outlet "
    ...
    def init_deep_link(self, request: HttpRequest):
        ...
        # - OutletName: According to the spec, this is optional.
