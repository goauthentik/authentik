...
class PassbookOutletOIDCConfig(AppConfig):
    """passbook auth oidc provider app config"""

    name = "passbook.channels.out_oidc"
    label = "passbook_channels_out_oidc"
    verbose_name = "passbook Outlets.OIDC"
    ...
    def ready(self):
        ...
        import_module("passbook.channels.out_oidc.signals")
