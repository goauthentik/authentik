...
class OIDCOutletForm(forms.ModelForm):
    """OpenID Client form"""
    ...
    def save(self, *args, **kwargs):
        ...
        if not OpenIDOutlet.objects.filter(oidc_client=self.instance).exists():
            OpenIDOutlet.objects.create(oidc_client=self.instance)
        return response
